...
public final class l {
    private static String a(int i10, int i11, String str) {
        if (i10 < 0) {
            return p.b("%s (%s) must not be negative", str, Integer.valueOf(i10));
        }
        if (i11 >= 0) {
            return p.b("%s (%s) must be less than size (%s)", str, Integer.valueOf(i10), Integer.valueOf(i11));
        }
    ...
    private static String b(int i10, int i11, String str) {
        ...
        if (i11 >= 0) {
            return p.b("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i10), Integer.valueOf(i11));
        }
        StringBuilder sb2 = new StringBuilder(26);
        sb2.append("negative size: ");
        sb2.append(i11);
    ...
    private static String c(int i10, int i11, int i12) {
        ...
        return (i11 < 0 || i11 > i12) ? b(i11, i12, "end index") : p.b("end index (%s) must not be less than start index (%s)", Integer.valueOf(i11), Integer.valueOf(i10));
    }
    ...
    public static void f(boolean z10, String str, int i10, int i11) {
        if (!z10) {
            throw new IllegalArgumentException(p.b(str, Integer.valueOf(i10), Integer.valueOf(i11)));
        }
    }

    public static void g(boolean z10, String str, long j10) {
        if (!z10) {
            throw new IllegalArgumentException(p.b(str, Long.valueOf(j10)));
        }
    }
