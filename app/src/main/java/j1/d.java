...
public enum d implements j1.a {
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final Set<String> f32175a = new HashSet(Arrays.asList(e.d().a()));
    }
    ...
    public static boolean i(String str) {
        ...
        return j(str, hashSet);
    }

    public static boolean j(String str, Collection<j1.a> collection) {
        HashSet<j1.a> hashSet = new HashSet();
    ...
    public boolean l() {
        return of.a.b(a.f32175a, this.f32173b);
    }
