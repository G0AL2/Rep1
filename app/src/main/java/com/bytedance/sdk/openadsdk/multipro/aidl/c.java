...
public class c implements Cursor {
    ...
    Map<String, List<String>> f13508a;
    ...
    public c(Map<String, List<String>> map) {
        if (map != null && map.keySet() != null) {
            this.f13508a = map;
            try {
                this.f13509b = (String[]) map.keySet().toArray(new String[map.keySet().size()]);
                return;
    ...
    public int getCount() {
        ...
        return this.f13508a.get(strArr[0]).size();
    }
    ...
    public String getString(int i10) {
        return (i10 < 0 || i10 >= getColumnCount()) ? "" : this.f13508a.get(this.f13509b[i10]).get(getPosition());
    }
    ...
    public boolean isLast() {
        return this.f13510c == getCount() - 1;
    }
    ...
    public boolean moveToLast() {
        ...
        this.f13510c = this.f13508a.get(this.f13509b[0]).size() - 1;
        return true;
    }

    @Override // android.database.Cursor
    public boolean moveToNext() {
        if (this.f13510c + 1 >= getCount()) {
            return false;
        }
        this.f13510c++;
        return true;
