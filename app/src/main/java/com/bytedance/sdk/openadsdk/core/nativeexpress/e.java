...
public class e extends com.bytedance.sdk.openadsdk.core.b.a {
    public e(Context context, com.bytedance.sdk.openadsdk.core.e.n nVar, String str, int i10) {
    ...
    public com.bytedance.sdk.openadsdk.core.e.g a(float f10, float f11, float f12, float f13, SparseArray<c.a> sparseArray, long j10, long j11, View view, View view2, String str, float f14, int i10, float f15, int i11, JSONObject jSONObject) {
        ...
        if (a10 == null || a10.length != 2) {
            ...
            if (this.f11884r == 0) {
                float f21 = i12;
                float f22 = i13;
                f18 = (v.b(this.f11868b, f12) + f21) - 0.5f;
                f19 = (v.b(this.f11868b, f13) + f22) - 0.5f;
                f17 = (v.b(this.f11868b, f11) + f22) - 0.5f;
                f16 = (v.b(this.f11868b, f10) + f21) - 0.5f;
            } else {
                f16 = f10;
                f17 = f11;
                f18 = f12;
        ...
        if (jVar != null) {
            ...
            j13 = jVar.f12087f;
            if (this.f11884r == 0) {
                iArr[0] = ((int) v.b(this.f11868b, jVar.f12088g)) + i12;
        ...
        this.f11884r = 0;
        return new g.a().f(f16).e(f17).d(f20).c(f19).b(j12).a(j13).b(a10).a(iArr).c(v.c(view)).d(iArr2).d(this.f11898y).e(this.f11899z).f(this.A).b(com.bytedance.sdk.openadsdk.core.h.d().b() ? 1 : 2).a(sparseArray).a(str).a(f14).c(i10).b(f15).a(i11).a(jSONObject).a();
    }
