...
public class e {
    ...
    public static void a(String str, int i10, String str2, String str3, String str4) {
        try {
            n a10 = com.bytedance.sdk.openadsdk.core.b.a(new JSONObject(f11605a));
            ...
            if (a10 != null) {
                ...
                if (a10.aa() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        a10.aa().a(str2);
                        a10.aa().b("Test the downloaded app");
                    } else {
                        a10.aa().a((String) null);
                        a10.aa().b("");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
                ...
                if (a10.M() != null) {
                    a10.M().a("https://p0.ipstatp.com/origin/ad-site-i18n-sg/202011255d0d219920adb0fd474eac28");
                }
                if (i10 == 1) {
                    a10.s(15);
                } else {
            ...
            k kVar = new k(m.a(), a10, new AdSlot.Builder().build());
            kVar.a(true);
            kVar.showFullScreenVideoAd(null);
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
