...
public class s {
    ...
    */
    ...
    public static String b(String str) {
        try {
            if (a()) {
                String u10 = com.bytedance.sdk.openadsdk.core.h.d().u();
                if (TextUtils.isEmpty(u10)) {
                    return str;
                }
                Log.d("TestHelperUtils", "AnyDoorId=" + u10);
                return Uri.parse(str).buildUpon().appendQueryParameter(b(), u10).appendQueryParameter("aid", "5001121").toString();
            }
            return str;
    ...
    public static String b() {
        if (TextUtils.isEmpty(f13596a)) {
            f13596a = new String(Base64.decode("ZGV2aWNlX2lk", 0));
        }
        return f13596a;
    }

    public static boolean a() {
        return com.bytedance.sdk.component.utils.l.c() && com.bytedance.sdk.openadsdk.core.h.d().s() && com.bytedance.sdk.openadsdk.core.h.d().t();
    }
}
