...
public final class InneractiveErrorCode {
    ...
    public static final /* synthetic */ InneractiveErrorCode[] f17154d;

    /* renamed from: a  reason: collision with root package name */
    public final String f17155a;

    /* renamed from: b  reason: collision with root package name */
    public final Metricable f17156b;

    /* renamed from: c  reason: collision with root package name */
    public final Metricable f17157c;
    ...
    static {
        ...
        InneractiveErrorCode inneractiveErrorCode6 = new InneractiveErrorCode("CONNECTION_TIMEOUT", 5, "Connection Timed Out.", metricable, metricable);
        CONNECTION_TIMEOUT = inneractiveErrorCode6;
        InneractiveErrorCode inneractiveErrorCode7 = new InneractiveErrorCode("CONNECTION_ERROR", 6, "Network Connection Error.", metricable, metricable2);
    ...
    public static InneractiveErrorCode[] values() {
        return (InneractiveErrorCode[]) f17154d.clone();
    }
    ...
    public boolean shouldSendTimeMetric() {
        return this.f17157c == Metricable.INCLUDED_IN_FAILED_METRICS;
    }
