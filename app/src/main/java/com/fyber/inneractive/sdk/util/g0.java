...
public class g0 {
    ...
    public static class c implements a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public Map f20278a = new HashMap();

        /* renamed from: b  reason: collision with root package name */
        public h0 f20279b = new h0();
    }
    ...
    public void a(String[][] strArr) {
        ...
        while (i10 < strArr.length) {
            String str = strArr[i10][c10];
            int parseInt = Integer.parseInt(strArr[i10][1]);
            c cVar = (c) this.f20277a;
            cVar.f20278a.put(str, Integer.valueOf(parseInt));
            h0 h0Var = cVar.f20279b;
            h0.a[] aVarArr = h0Var.f20281a;
            int i11 = Api.BaseClientBuilder.API_PRIORITY_OTHER;
            int i12 = parseInt & Api.BaseClientBuilder.API_PRIORITY_OTHER;
            int length = i12 % aVarArr.length;
            h0.a aVar = aVarArr[length];
            while (true) {
                if (aVar != null) {
                    if (aVar.f20284a == parseInt) {
                        aVar.f20285b = str;
                        break;
                    }
                    aVar = aVar.f20286c;
                } else {
                    if (h0Var.f20282b >= h0Var.f20283c) {
                        h0.a[] aVarArr2 = h0Var.f20281a;
                        int length2 = aVarArr2.length;
                        int i13 = (length2 * 2) + 1;
                        h0.a[] aVarArr3 = new h0.a[i13];
                        h0Var.f20283c = (int) (i13 * 0.75f);
                        h0Var.f20281a = aVarArr3;
                        while (true) {
                            int i14 = length2 - 1;
                            if (length2 <= 0) {
                                break;
                            }
                            h0.a aVar2 = aVarArr2[i14];
                            while (aVar2 != null) {
                                h0.a aVar3 = aVar2.f20286c;
                                int i15 = (aVar2.f20284a & i11) % i13;
                                aVar2.f20286c = aVarArr3[i15];
                                aVarArr3[i15] = aVar2;
                                aVar2 = aVar3;
    ...
    */
    public final void a(java.io.Writer r11, java.lang.String r12, int r13) throws java.io.IOException {
        ...
        L65:
            ...
            goto L77
        L6b:
            com.fyber.inneractive.sdk.util.g0$a r2 = r10.f20277a
            com.fyber.inneractive.sdk.util.g0$c r2 = (com.fyber.inneractive.sdk.util.g0.c) r2
            java.util.Map r2 = r2.f20278a
