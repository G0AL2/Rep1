    ...
    */
    public h(java.util.List<com.ironsource.mediationsdk.model.NetworkSettings> r18, com.ironsource.mediationsdk.model.o r19, java.lang.String r20, boolean r21, java.util.Set<com.ironsource.mediationsdk.impressionData.ImpressionDataListener> r22, com.ironsource.mediationsdk.IronSourceSegment r23) {
        /*
            ...
            com.ironsource.mediationsdk.utils.c r4 = r0.f27291l
            int r5 = r0.f27282c
            int r6 = r0.f27284e
            int r7 = r0.f27289j
            int r8 = r0.f27288i
            if (r21 == 0) goto L16
            com.ironsource.mediationsdk.adunit.c.b.a$a r0 = com.ironsource.mediationsdk.adunit.c.b.a.EnumC0342a.MANUAL
        L14:
            r12 = r0
            goto L20
        L16:
            boolean r0 = r4.f27421n
            if (r0 == 0) goto L1d
            com.ironsource.mediationsdk.adunit.c.b.a$a r0 = com.ironsource.mediationsdk.adunit.c.b.a.EnumC0342a.AUTOMATIC_LOAD_WHILE_SHOW
            goto L14
        L1d:
            com.ironsource.mediationsdk.adunit.c.b.a$a r0 = com.ironsource.mediationsdk.adunit.c.b.a.EnumC0342a.AUTOMATIC_LOAD_AFTER_CLOSE
            goto L14
        L20:
    ...
    protected final /* synthetic */ com.ironsource.mediationsdk.adunit.d.a.c a(NetworkSettings networkSettings, BaseAdAdapter baseAdAdapter, int i10, String str) {
        ...
        a aVar = this.f26890m;
        return new com.ironsource.mediationsdk.adunit.d.c(new com.ironsource.mediationsdk.adunit.d.a(ad_unit, aVar.f26857b, i10, this.f26885h, str, this.f26883f, this.f26884g, networkSettings, aVar.f26862g), (BaseAdInteractionAdapter) baseAdAdapter, this);
    }
}
