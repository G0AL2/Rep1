    ...
    public boolean initSuccessful(Object obj) {
        ...
        if (obj2 != null) {
            if (this._adapterStatusBridge.isGMAInitialized(obj2)) {
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.GMA, c.INIT_SUCCESS, new Object[0]);
                return true;
            }
            WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.GMA, c.INIT_ERROR, new Object[0]);
        }
        return false;
    }
