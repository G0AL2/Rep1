    ...
    public boolean prepare(String str, final float f10, int i10) {
        ...
        setOnErrorListener(new MediaPlayer.OnErrorListener() { // from class: com.unity3d.services.ads.video.VideoPlayerView.4
            ...
            public boolean onError(MediaPlayer mediaPlayer, int i11, int i12) {
                ...
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.VIDEOPLAYER, VideoPlayerEvent.GENERIC_ERROR, VideoPlayerView.this._videoUrl, Integer.valueOf(i11), Integer.valueOf(i12));
                VideoPlayerView.this.stopVideoProgressTimer();
                return true;
            }
        });
            ...
            if (z10) {
                setOnInfoListener(new MediaPlayer.OnInfoListener() { // from class: com.unity3d.services.ads.video.VideoPlayerView.6
                    ...
                    public boolean onInfo(MediaPlayer mediaPlayer, int i10, int i11) {
                        WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.VIDEOPLAYER, VideoPlayerEvent.INFO, VideoPlayerView.this._videoUrl, Integer.valueOf(i10), Integer.valueOf(i11));
                        return true;
                    }
                });
            } else {
