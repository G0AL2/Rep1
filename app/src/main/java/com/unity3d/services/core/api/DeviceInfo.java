...
public class DeviceInfo {
    ...
    private static File getFileForStorageType(StorageType storageType) {
        int i10 = AnonymousClass2.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            IVolumeChangeListener iVolumeChangeListener = new IVolumeChangeListener(num) { // from class: com.unity3d.services.core.api.DeviceInfo.1
                ...
                public void onVolumeChanged(int i10) {
                    WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.DEVICEINFO, DeviceInfoEvent.VOLUME_CHANGED, Integer.valueOf(getStreamType()), Integer.valueOf(i10), Integer.valueOf(Device.getStreamMaxVolume(this._streamType)));
                }
            };
