...
public final class zzlt implements zzan {
    private static final ThreadLocal zza = new zzlr();
    private static final ThreadLocal zzb = new zzls();
    private final byte[] zzc;
    private final byte[] zzd;
    private final SecretKeySpec zze;
    private final int zzf;

    public zzlt(byte[] bArr, int i10) throws GeneralSecurityException {
        if (!zzdl.zza(1)) {
    ...
    private static byte[] zzc(byte[] bArr) {
        ...
        while (i10 < 15) {
            byte b10 = bArr[i10];
            int i11 = i10 + 1;
            bArr2[i10] = (byte) (((b10 + b10) ^ ((bArr[i11] & fq.i.NETWORK_LOAD_LIMIT_DISABLED) >>> 7)) & 255);
            i10 = i11;
        }
        byte b11 = bArr[15];
