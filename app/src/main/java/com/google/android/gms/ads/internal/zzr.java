...
public final class zzr {
    ...
    public zzr(Context context, String str) {
        ...
        try {
            concat = packageName + Constants.FILENAME_SEQUENCE_SEPARATOR + Wrappers.packageManager(context).getPackageInfo(context.getPackageName(), 0).versionName;
        } catch (PackageManager.NameNotFoundException e10) {
            zzcfi.zzh("Unable to get package version name for reporting", e10);
    ...
    public final void zzf(com.google.android.gms.ads.internal.client.zzl zzlVar, zzcfo zzcfoVar) {
        ...
        if (((Boolean) zzbjd.zza.zze()).booleanValue()) {
            try {
                Bundle zzc = zzetd.zzc(this.zza, new JSONArray((String) zzbjd.zzb.zze()));
