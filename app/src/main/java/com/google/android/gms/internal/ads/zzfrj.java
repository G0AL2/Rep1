...
public abstract class zzfrj extends zzfre implements List, RandomAccess {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static zzfrj zzk(Object[] objArr, int i10) {
        if (i10 == 0) {
            return zzfss.zza;
        }
        return new zzfss(objArr, i10);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i10 = 0; i10 < size; i10++) {
                        if (zzfoq.zza(get(i10), list.get(i10))) {
                        }
                    }
                    return true;
                }
    ...
    @Override // java.util.List
    /* renamed from: zzh */
    public zzfrj subList(int i10, int i11) {
        zzfou.zzg(i10, i11, size());
        int i12 = i11 - i10;
        if (i12 == size()) {
            return this;
        }
        ...
        return new zzfri(this, i10, i12);
    }

    @Override // java.util.List
    /* renamed from: zzu */
    public final zzftj listIterator(int i10) {
        zzfou.zzb(i10, size(), "index");
        return isEmpty() ? zza : new zzfrh(this, i10);
    }
}
