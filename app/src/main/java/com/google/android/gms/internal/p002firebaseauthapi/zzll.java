...
public final class zzll extends zzzl implements zzaar {
    ...
    public static zzll zzd(zzyi zzyiVar, zzyy zzyyVar) throws zzzt {
        return (zzll) zzzl.zzw(zzb, zzyiVar, zzyyVar);
    }
