...
public final class zzti {
    ...
    */
    public static ob.k zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 480
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzti.zza(com.google.android.gms.common.api.Status):ob.k");
    }

    public static k zzb(Status status, AuthCredential authCredential, String str, String str2) {
        int statusCode = status.getStatusCode();
        if (statusCode != 17012 && statusCode != 17007 && statusCode != 17025) {
            return zza(status);
        }
        q qVar = new q(zzd(statusCode), zze(zzf(statusCode), status));
        qVar.b(authCredential);
        qVar.c(str);
        qVar.d(str2);
        return qVar;
    }

    public static n zzc(FirebaseAuth firebaseAuth, zzps zzpsVar, FirebaseUser firebaseUser) {
        ...
        List<MultiFactorInfo> zzc = zzpsVar.zzc();
        ...
        return new n(str, str2, new zzae(arrayList, zzag.j1(zzpsVar.zzc(), zzpsVar.zzb()), firebaseAuth.i().p(), zzpsVar.zza(), (zzx) firebaseUser));
    }
