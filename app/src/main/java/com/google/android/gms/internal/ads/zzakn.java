...
public final class zzakn {
    public static double zza(ByteBuffer byteBuffer) {
        ...
        byteBuffer.get(bArr);
        return (((((bArr[0] << 24) & (-16777216)) | ((bArr[1] << 16) & 16711680)) | ((bArr[2] << 8) & 65280)) | (bArr[3] & fq.i.NETWORK_LOAD_LIMIT_DISABLED)) / 1.073741824E9d;
    }

    public static double zzb(ByteBuffer byteBuffer) {
        byte[] bArr = new byte[4];
        byteBuffer.get(bArr);
        return (((((bArr[0] << 24) & (-16777216)) | ((bArr[1] << 16) & 16711680)) | ((bArr[2] << 8) & 65280)) | (bArr[3] & fq.i.NETWORK_LOAD_LIMIT_DISABLED)) / 65536.0d;
    }
