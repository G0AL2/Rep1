...
public final class zzbzt extends AbstractSafeParcelable {
    ...
    public zzbzt(@SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor) {
        ...
        if (this.zza == null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        zzcfv.zza.execute(new Runnable() { // from class: com.google.android.gms.internal.ads.zzbzs
        ...
        if (this.zzc) {
            ...
            try {
                try {
                    ...
                    zzcfi.zzh("Could not read from parcel file descriptor", e10);
                    IOUtils.closeQuietly(dataInputStream);
                    return null;
                }
            } catch (Throwable th2) {
