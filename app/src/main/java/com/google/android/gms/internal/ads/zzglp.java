...
final class zzglp extends zzgis implements RandomAccess, zzgky, zzgmh {
    ...
    static {
        zzglp zzglpVar = new zzglp(new long[0], 0);
        zza = zzglpVar;
        zzglpVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        zzglp zzglpVar = (zzglp) collection;
        int i10 = zzglpVar.zzc;
        if (i10 == 0) {
            return false;
        }
        int i11 = this.zzc;
        if (Api.BaseClientBuilder.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzglpVar.zzb, 0, this.zzb, this.zzc, zzglpVar.zzc);
            this.zzc = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzglpVar.zzc) {
            return false;
        }
        long[] jArr = zzglpVar.zzb;
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzgla.zzc(this.zzb[i11]);
        }
        return i10;
    }
    ...
    /* renamed from: zza */
    public final zzgky zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzglp(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
    ...
    private zzglp(long[] jArr, int i10) {
        this.zzb = jArr;
        this.zzc = i10;
    }
