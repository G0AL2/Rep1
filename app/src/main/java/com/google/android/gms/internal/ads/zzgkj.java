...
final class zzgkj extends zzgis implements RandomAccess, zzgmh {
    private static final zzgkj zza;
    private float[] zzb;
    private int zzc;

    static {
        zzgkj zzgkjVar = new zzgkj(new float[0], 0);
        zza = zzgkjVar;
        zzgkjVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        zzgkj zzgkjVar = (zzgkj) collection;
        int i10 = zzgkjVar.zzc;
        if (i10 == 0) {
            return false;
        }
        int i11 = this.zzc;
        if (Api.BaseClientBuilder.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzgkjVar.zzb, 0, this.zzb, this.zzc, zzgkjVar.zzc);
            this.zzc = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgkj zzgkjVar = (zzgkj) obj;
        if (this.zzc != zzgkjVar.zzc) {
            return false;
        }
        float[] fArr = zzgkjVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgkz zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzgkj(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
    ...
    private zzgkj(float[] fArr, int i10) {
        this.zzb = fArr;
        this.zzc = i10;
    }
