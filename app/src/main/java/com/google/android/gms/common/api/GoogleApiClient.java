...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(d dVar);
    ...
    public static final class Builder {
        ...
        public Builder enableAutoManage(d dVar, int i10, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        public Builder enableAutoManage(d dVar, OnConnectionFailedListener onConnectionFailedListener) {
