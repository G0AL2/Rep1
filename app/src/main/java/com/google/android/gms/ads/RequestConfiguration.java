...
public class RequestConfiguration {
    ...
    public static class Builder {
        ...
        public Builder setTagForChildDirectedTreatment(int i10) {
            if (i10 == -1 || i10 == 0 || i10 == 1) {
                ...
                zzcfi.zzj("Invalid value passed to setTagForChildDirectedTreatment: " + i10);
            }
            return this;
        }
        ...
        public Builder setTagForUnderAgeOfConsent(int i10) {
            if (i10 == -1 || i10 == 0 || i10 == 1) {
                ...
                zzcfi.zzj("Invalid value passed to setTagForUnderAgeOfConsent: " + i10);
            }
            return this;
        }
    ...
    /* synthetic */ RequestConfiguration(int i10, int i11, String str, List list, zze zzeVar) {
        this.zzb = i10;
        this.zzc = i11;
        this.zzd = str;
        this.zze = list;
