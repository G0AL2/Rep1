...
public final class zzcgv extends zzcgx implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public zzcgv(Context context, zzchr zzchrVar, boolean z10, boolean z11, zzchq zzchqVar, zzchs zzchsVar) {
        super(context);
        this.zzg = 0;
        this.zzh = 0;
        this.zzr = false;
    ...
    private final void zzC() {
        ...
        try {
            ...
            zzcfi.zzk("Failed to initialize MediaPlayer at ".concat(String.valueOf(this.zzj)), e10);
    ...
    */
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        int i11 = this.zzk;
        int i12 = this.zzl;
        zzcfi.zzi("AdMediaPlayerView stream dimensions: " + i11 + " x " + i12);
        if (this.zzh == 3) {
            zzp();
        }
        zzn();
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i10, int i11) {
        ...
        com.google.android.gms.ads.internal.util.zzs.zza.post(new zzcgr(this, i10, i11));
    }
    ...
    public final String toString() {
        String name = zzcgv.class.getName();
