...
public final class zzrx extends zzuh {
    private final zzxe zza;

    public zzrx(AuthCredential authCredential) {
        super(2);
        Preconditions.checkNotNull(authCredential, "credential cannot be null");
        this.zza = f0.a(authCredential, null);
    }
    ...
    public final void zzc(TaskCompletionSource taskCompletionSource, zzth zzthVar) {
        ...
        zzthVar.zzm(new zzoc(this.zze.zzf(), this.zza), this.zzc);
    }
}
