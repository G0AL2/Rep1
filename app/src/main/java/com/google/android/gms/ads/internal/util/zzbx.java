        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    zzcfi.zzh("Error occurred while putting signals into JSON object.", e10);
                }
    ...
    */
    ...
    public static boolean zzi(int i10) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzay.zzc().zzb(zzbhz.zzcD)).booleanValue()) {
            return ((Boolean) com.google.android.gms.ads.internal.client.zzay.zzc().zzb(zzbhz.zzcE)).booleanValue() || i10 <= 15299999;
        }
        return true;
    }
