...
public final class zzrz extends zzuh {
    private final EmailAuthCredential zza;

    public zzrz(EmailAuthCredential emailAuthCredential) {
        super(2);
    ...
    public final void zzc(TaskCompletionSource taskCompletionSource, zzth zzthVar) {
        ...
        emailAuthCredential.m1(this.zze);
        zzthVar.zzx(new zzoy(emailAuthCredential), this.zzc);
    }
}
