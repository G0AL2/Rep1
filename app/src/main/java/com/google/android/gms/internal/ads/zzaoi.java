...
public final class zzaoi {
    ...
    public final String zza(byte[] bArr, byte[] bArr2) throws zzaoh {
        ...
        try {
            ...
            throw new zzaoh(this, e10);
        } catch (NoSuchAlgorithmException e11) {
            throw new zzaoh(this, e11);
        } catch (BadPaddingException e12) {
            throw new zzaoh(this, e12);
        } catch (IllegalBlockSizeException e13) {
            throw new zzaoh(this, e13);
        } catch (NoSuchPaddingException e14) {
            throw new zzaoh(this, e14);
        }
    }
    ...
    public final byte[] zzb(byte[] bArr, String str) throws zzaoh {
        ...
        try {
            ...
            throw new zzaoh(this, e15);
        } catch (NoSuchPaddingException e16) {
            throw new zzaoh(this, e16);
        }
    }
}
