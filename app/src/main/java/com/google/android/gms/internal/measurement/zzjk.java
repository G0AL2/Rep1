...
final class zzjk implements zznd {
    ...
    public final void zzB(int i10, List list, boolean z10) throws IOException {
        ...
        while (i11 < list.size()) {
            ...
            zzjjVar2.zzp(i10, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i11++;
        }
    }
    ...
    public final void zzD(int i10, List list, boolean z10) throws IOException {
        ...
        while (i11 < list.size()) {
            ...
            zzjjVar2.zzr(i10, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i11++;
        }
    }
    ...
    public final void zzI(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzjj.zzA(((Integer) list.get(i13)).intValue());
            }
            this.zza.zzq(i12);
            while (i11 < list.size()) {
    ...
    public final void zzK(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzjj.zzB(((Long) list.get(i13)).longValue());
            }
            this.zza.zzq(i12);
            while (i11 < list.size()) {
    ...
    public final void zzj(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzjj.zzv(((Integer) list.get(i13)).intValue());
            }
            this.zza.zzq(i12);
            while (i11 < list.size()) {
