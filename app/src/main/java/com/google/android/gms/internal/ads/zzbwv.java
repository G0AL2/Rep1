...
public class zzbwv {
    ...
    public final void zzf(int i10, int i11, int i12, int i13) {
        try {
            ...
            zzcfi.zzh("Error occurred while dispatching default position.", e10);
        }
    }
    ...
    public final void zzg(String str) {
        try {
            ...
            zzcfi.zzh("Error occurred while dispatching error event.", e10);
        }
    }
    ...
    public final void zzh(String str) {
        try {
            ...
            zzcfi.zzh("Error occurred while dispatching ready Event.", e10);
        }
    }
    ...
    public final void zzi(int i10, int i11, int i12, int i13, float f10, int i14) {
        try {
            ...
            zzcfi.zzh("Error occurred while obtaining screen information.", e10);
        }
    }
    ...
    public final void zzj(int i10, int i11, int i12, int i13) {
        try {
            ...
            zzcfi.zzh("Error occurred while dispatching size change.", e10);
        }
    }
    ...
    public final void zzk(String str) {
        try {
            ...
            zzcfi.zzh("Error occurred while dispatching state change.", e10);
        }
    }
}
