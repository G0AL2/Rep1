    ...
    */
    ...
    private final void zzl(View view) {
        ...
        if (application != null) {
            try {
                ...
                zzcfi.zzh("Error registering activity lifecycle callbacks.", e10);
            }
        }
    }
    ...
    private final void zzm(View view) {
        try {
            ...
            zzcfi.zzh("Error while unregistering listeners from the last ViewTreeObserver.", e10);
        }
        try {
            ...
            zzcfi.zzh("Error while unregistering listeners from the ViewTreeObserver.", e11);
        }
        if (this.zza != null) {
            try {
                com.google.android.gms.ads.internal.zzt.zzv().zzd(this.zzd, this.zza);
            } catch (IllegalStateException e12) {
                zzcfi.zzh("Failed trying to unregister the receiver", e12);
            } catch (Exception e13) {
                com.google.android.gms.ads.internal.zzt.zzo().zzt(e13, "ActiveViewUnit.stopScreenStatusMonitoring");
            }
            this.zza = null;
        }
        Application application = this.zze;
        if (application != null) {
            try {
                ...
                zzcfi.zzh("Error registering activity lifecycle callbacks.", e14);
            }
        }
    }
