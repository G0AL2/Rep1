...
public final class zzm extends WebViewClient {
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        ...
        if (zzbfVar != null) {
            try {
                zzbfVar2 = zzsVar.zzg;
                zzbfVar2.zzf(zzfdc.zzd(1, null, null));
        ...
        if (str.startsWith("gmsg://noAdLoaded")) {
            ...
            if (zzbfVar10 != null) {
                try {
                    ...
                    zzbfVar11.zzf(zzfdc.zzd(3, null, null));
                } catch (RemoteException e10) {
                    zzcfi.zzl("#007 Could not call remote method.", e10);
                }
            }
            ...
            if (zzbfVar6 != null) {
                try {
                    ...
                    zzbfVar7.zzf(zzfdc.zzd(1, null, null));
            ...
            if (zzbfVar4 != null) {
                try {
                    ...
                    zzcfi.zzl("#007 Could not call remote method.", e14);
                }
            }
            ...
            if (zzbfVar != null) {
                try {
                    ...
                    zzcfi.zzl("#007 Could not call remote method.", e15);
                }
            }
