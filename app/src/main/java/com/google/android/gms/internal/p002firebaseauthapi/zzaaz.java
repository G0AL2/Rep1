...
final class zzaaz extends zzxt implements RandomAccess {
    private static final zzaaz zza;
    private Object[] zzb;
    private int zzc;

    static {
        zzaaz zzaazVar = new zzaaz(new Object[0], 0);
        zza = zzaazVar;
        zzaazVar.zzb();
    }
    ...
    public final /* bridge */ /* synthetic */ zzzq zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzaaz(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    private zzaaz(Object[] objArr, int i10) {
        this.zzb = objArr;
        this.zzc = i10;
    }
