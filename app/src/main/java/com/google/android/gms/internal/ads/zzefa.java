...
public final class zzefa extends zzbxk {
    ...
    public static void zzd(Context context, zzdwh zzdwhVar, zzfgp zzfgpVar, zzees zzeesVar, String str, String str2, Map map) {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzay.zzc().zzb(zzbhz.zzhj)).booleanValue()) {
            ...
            zzb.zza("gqi", str);
            zzb.zza("device_connectivity", true == com.google.android.gms.ads.internal.zzt.zzo().zzv(context) ? b.ONLINE_EXTRAS_KEY : "offline");
            ...
            zza.zzb("gqi", str);
            zza.zzb("action", str2);
            zza.zzb("device_connectivity", true == com.google.android.gms.ads.internal.zzt.zzo().zzv(context) ? b.ONLINE_EXTRAS_KEY : "offline");
    ...
    public static void zzh(final Activity activity, final com.google.android.gms.ads.internal.overlay.zzl zzlVar, final com.google.android.gms.ads.internal.util.zzbr zzbrVar, final zzees zzeesVar, final zzdwh zzdwhVar, final zzfgp zzfgpVar, final String str, final String str2) {
            ...
            */
            public final void onClick(android.content.DialogInterface r19, int r20) {
                /*
                    r18 = this;
                    r1 = r18
                    com.google.android.gms.internal.ads.zzdwh r9 = com.google.android.gms.internal.ads.zzdwh.this
                    android.app.Activity r10 = r2
                    com.google.android.gms.internal.ads.zzfgp r11 = r3
                    com.google.android.gms.internal.ads.zzees r12 = r4
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (zzdwhVar2 != null) {
                    ...
                    zzefa.zzd(activity2, zzdwhVar2, zzfgpVar2, zzeesVar2, str3, "dialog_click", hashMap);
                }
                if (zzlVar2 != null) {
                    zzlVar2.zzb();
                }
    ...
    public final void zze(Intent intent) {
        ...
        if (stringExtra.equals("offline_notification_clicked") || stringExtra.equals("offline_notification_dismissed")) {
            ...
            try {
                ...
                zzcfi.zzg("Failed to get writable offline buffering database: ".concat(e10.toString()));
            }
        }
    }
    ...
    public final void zzf() {
        ...
        zzeesVar.zze(new zzffi() { // from class: com.google.android.gms.internal.ads.zzeeo
            ...
            public final Object zza(Object obj) {
                zzees.zzb(zzcfn.this, (SQLiteDatabase) obj);
                return null;
            }
        });
    }
    ...
    public final void zzg(IObjectWrapper iObjectWrapper, String str, String str2) {
        ...
        int i10 = zzfoa.zza;
        PendingIntent zza = zzfoa.zza(context, 0, intent, i10 | 1073741824, 0);
        Intent intent2 = new Intent();
        intent2.setClass(context, AdService.class);
        intent2.setAction("offline_notification_dismissed");
        intent2.putExtra("offline_notification_action", "offline_notification_dismissed");
        intent2.putExtra("gws_query_id", str2);
        PendingIntent zza2 = zzfoa.zza(context, 0, intent2, i10 | 1073741824, 0);
        Resources zzd = com.google.android.gms.ads.internal.zzt.zzo().zzd();
        ((NotificationManager) context.getSystemService("notification")).notify(str2, 54321, new i.e(context, "offline_notification_channel").k(zzd == null ? "View the ad you saved when you were offline" : zzd.getString(R.string.offline_notification_title)).j(zzd == null ? "Tap to open ad" : zzd.getString(R.string.offline_notification_text)).f(true).m(zza2).i(zza).x(context.getApplicationInfo().icon).b());
