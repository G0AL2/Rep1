...
public interface zze extends IInterface {
    ...
    Bundle zzm(int i10, String str, String str2, String str3, Bundle bundle) throws RemoteException;

    void zzn(int i10, String str, Bundle bundle, zzg zzgVar) throws RemoteException;

    int zzr(int i10, String str, String str2) throws RemoteException;
}
