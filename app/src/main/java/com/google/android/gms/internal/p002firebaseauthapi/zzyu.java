...
final class zzyu {
    ...
    private zzyu(zzyt zzytVar) {
        zzzr.zzf(zzytVar, "output");
        this.zza = zzytVar;
        zzytVar.zze = this;
    }

    public static zzyu zza(zzyt zzytVar) {
        zzyu zzyuVar = zzytVar.zze;
        return zzyuVar != null ? zzyuVar : new zzyu(zzytVar);
    }
    ...
    public final void zzB(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                ...
                i12 += zzyt.zzE((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
                zzyt zzytVar = this.zza;
                int intValue2 = ((Integer) list.get(i11)).intValue();
                zzytVar.zzs((intValue2 >> 31) ^ (intValue2 + intValue2));
                i11++;
            }
            return;
        }
        while (i11 < list.size()) {
            zzyt zzytVar2 = this.zza;
            int intValue3 = ((Integer) list.get(i11)).intValue();
            zzytVar2.zzr(i10, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i11++;
        }
    }
    ...
    public final void zzD(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                ...
                i12 += zzyt.zzF((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
                zzyt zzytVar = this.zza;
                long longValue2 = ((Long) list.get(i11)).longValue();
                zzytVar.zzu((longValue2 >> 63) ^ (longValue2 + longValue2));
                i11++;
            }
            return;
        }
        while (i11 < list.size()) {
            ...
            zzytVar2.zzt(i10, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i11++;
        }
    }
    ...
    public final void zzI(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzyt.zzE(((Integer) list.get(i13)).intValue());
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
    ...
    public final void zzK(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzyt.zzF(((Long) list.get(i13)).longValue());
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
    ...
    public final void zzd(int i10, zzyi zzyiVar) throws IOException {
        this.zza.zzQ(i10, zzyiVar);
    }

    public final void zze(int i10, List list) throws IOException {
        for (int i11 = 0; i11 < list.size(); i11++) {
            this.zza.zzQ(i10, (zzyi) list.get(i11));
        }
    }
    ...
    public final void zzj(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzyt.zzy(((Integer) list.get(i13)).intValue());
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
    ...
    public final void zzq(int i10, Object obj, zzabc zzabcVar) throws IOException {
        zzyt zzytVar = this.zza;
        zzytVar.zzq(i10, 3);
        zzabcVar.zzn((zzaaq) obj, zzytVar.zze);
        zzytVar.zzq(i10, 4);
    }
    ...
    public final void zzv(int i10, Object obj, zzabc zzabcVar) throws IOException {
        this.zza.zzn(i10, (zzaaq) obj, zzabcVar);
    }
