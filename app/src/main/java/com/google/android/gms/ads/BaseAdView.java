...
public abstract class BaseAdView extends ViewGroup {
                ...
                zzcex.zzb.execute(new Runnable() { // from class: com.google.android.gms.ads.zzc
                    ...
                    public final void run() {
                        ...
                        try {
                            ...
                            zzbyy.zza(baseAdView.getContext()).zzd(e10, "BaseAdView.loadAd");
                        }
                    }
                });
                return;
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (childAt != null && childAt.getVisibility() != 8) {
            ...
            try {
                ...
                zzcfi.zzh("Unable to retrieve ad size.", e10);
                adSize = null;
            }
            if (adSize != null) {
    ...
    public BaseAdView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.zza = new zzdu(this, attributeSet, false, i10);
    }
    ...
    public BaseAdView(Context context, AttributeSet attributeSet, int i10, int i11, boolean z10) {
        super(context, attributeSet, i10);
        this.zza = new zzdu(this, attributeSet, z10, i11);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public BaseAdView(Context context, AttributeSet attributeSet, boolean z10) {
        super(context, attributeSet);
        this.zza = new zzdu(this, attributeSet, z10);
    }
}
