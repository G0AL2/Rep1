...
public final class zzqr implements zzum {
    final /* synthetic */ String zza;
    final /* synthetic */ zztg zzb;
    final /* synthetic */ zzrl zzc;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzqr(zzrl zzrlVar, String str, zztg zztgVar) {
        this.zzc = zzrlVar;
        this.zza = str;
        this.zzb = zztgVar;
    }
    ...
    public final /* bridge */ /* synthetic */ void zzb(Object obj) {
        zzun zzunVar;
        zzxo zzxoVar = new zzxo(((zzwe) obj).zze(), this.zza);
        zzunVar = this.zzc.zza;
        zzunVar.zzu(zzxoVar, new zzqq(this));
    }
}
