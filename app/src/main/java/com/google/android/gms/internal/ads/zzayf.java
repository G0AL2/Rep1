...
public final class zzayf {
    ...
    public final boolean zza(zzayf zzayfVar, int i10) {
        return zzayfVar != null && zzazo.zzo(this.zzb.zza(i10), zzayfVar.zzb.zza(i10)) && zzazo.zzo(this.zzd[i10], zzayfVar.zzd[i10]);
    }
}
