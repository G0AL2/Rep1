...
interface zzgml {
    ...
    @Deprecated
    void zzC(List list, zzgmt zzgmtVar, zzgkc zzgkcVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgmt zzgmtVar, zzgkc zzgkcVar) throws IOException;
    ...
    @Deprecated
    Object zzr(zzgmt zzgmtVar, zzgkc zzgkcVar) throws IOException;

    Object zzs(zzgmt zzgmtVar, zzgkc zzgkcVar) throws IOException;
