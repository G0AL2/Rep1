...
interface zzabb {
    ...
    @Deprecated
    void zzC(List list, zzabc zzabcVar, zzyy zzyyVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzabc zzabcVar, zzyy zzyyVar) throws IOException;
    ...
    zzyi zzp() throws IOException;

    @Deprecated
    Object zzr(zzabc zzabcVar, zzyy zzyyVar) throws IOException;

    Object zzs(zzabc zzabcVar, zzyy zzyyVar) throws IOException;
