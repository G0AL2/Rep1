...
public final class zzghd implements zzfwf {
    ...
    public zzghd(byte[] bArr, int i10) throws GeneralSecurityException {
        if (!zzfze.zza(1)) {
    ...
    public final byte[] zzb(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        int length = bArr.length;
        int i10 = this.zzf;
        if (length <= (Api.BaseClientBuilder.API_PRIORITY_OTHER - i10) - 16) {
            ...
            for (int i12 = 0; i12 < 16; i12++) {
                bArr3[i11 + i12] = (byte) ((zzd2[i12] ^ zzd[i12]) ^ zzd3[i12]);
            }
            return bArr3;
        }
