...
final class zzdr extends zzdn<Boolean> implements RandomAccess, zzeu {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < this.zzc; i11++) {
            i10 = (i10 * 31) + zzev.zza(this.zzb[i11]);
        }
        return i10;
    }
    ...
    public final /* bridge */ /* synthetic */ zzeu zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzdr(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
    ...
    private zzdr(boolean[] zArr, int i10) {
        this.zzb = zArr;
        this.zzc = i10;
    }
