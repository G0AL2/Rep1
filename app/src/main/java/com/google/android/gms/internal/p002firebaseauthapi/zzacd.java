...
public final class zzacd {
    ...
    private static final zzacc zzf;
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzacd.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j10, byte b10) {
        long j11 = (-4) & j10;
        zzacc zzaccVar = zzf;
        int zzj = zzaccVar.zzj(obj, j11);
        int i10 = ((~((int) j10)) & 3) << 3;
        zzaccVar.zzn(obj, j11, ((255 & b10) << i10) | (zzj & (~(255 << i10))));
    }
    ...
    public static void zzE(Object obj, long j10, byte b10) {
        ...
        zzacc zzaccVar = zzf;
        int i10 = (((int) j10) & 3) << 3;
        zzaccVar.zzn(obj, j11, ((255 & b10) << i10) | (zzaccVar.zzj(obj, j11) & (~(255 << i10))));
    }
    ...
    public static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzabz());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzacd.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
