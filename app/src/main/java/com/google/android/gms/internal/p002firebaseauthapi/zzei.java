...
final class zzei {
    ...
    private final byte[] zze(byte[] bArr, byte[] bArr2, int i10) throws GeneralSecurityException {
        Mac mac = (Mac) zzmh.zzb.zza(this.zza);
