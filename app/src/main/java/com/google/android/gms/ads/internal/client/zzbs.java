...
public interface zzbs extends IInterface {
    ...
    void zzM(zzbye zzbyeVar) throws RemoteException;

    void zzN(boolean z10) throws RemoteException;

    void zzO(zzbiu zzbiuVar) throws RemoteException;

    void zzP(zzde zzdeVar) throws RemoteException;

    void zzQ(zzbyh zzbyhVar, String str) throws RemoteException;

    void zzR(String str) throws RemoteException;

    void zzS(zzcar zzcarVar) throws RemoteException;
