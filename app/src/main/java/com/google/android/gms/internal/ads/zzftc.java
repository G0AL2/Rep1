...
public final class zzftc extends zzftb implements SortedSet {
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzftc(SortedSet sortedSet, zzfov zzfovVar) {
        super(sortedSet, zzfovVar);
    }
