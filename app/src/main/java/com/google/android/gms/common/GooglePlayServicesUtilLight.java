...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean zza(Context context, String str) {
        ...
        try {
            applicationInfo = context.getPackageManager().getApplicationInfo(str, Constants.BUFFER_SIZE);
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i10) {
        ...
        try {
            ...
            if (!GoogleSignatureVerifier.zzb(packageInfo2, true)) {
                ...
                } else if (com.google.android.gms.common.util.zza.zza(packageInfo2.versionCode) < com.google.android.gms.common.util.zza.zza(i10)) {
