...
public final class zzbyx implements Thread.UncaughtExceptionHandler {
    final /* synthetic */ Thread.UncaughtExceptionHandler zza;
    final /* synthetic */ zzbyy zzb;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzbyx(zzbyy zzbyyVar, Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
        this.zzb = zzbyyVar;
