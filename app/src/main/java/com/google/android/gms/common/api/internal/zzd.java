...
public final class zzd extends Fragment implements LifecycleFragment {
    private static final WeakHashMap<d, WeakReference<zzd>> zza = new WeakHashMap<>();
    ...
    public static zzd zzc(d dVar) {
        zzd zzdVar;
        WeakHashMap<d, WeakReference<zzd>> weakHashMap = zza;
        WeakReference<zzd> weakReference = weakHashMap.get(dVar);
        if (weakReference == null || (zzdVar = weakReference.get()) == null) {
            try {
                zzd zzdVar2 = (zzd) dVar.getSupportFragmentManager().i0("SupportLifecycleFragmentImpl");
                if (zzdVar2 == null || zzdVar2.isRemoving()) {
                    zzdVar2 = new zzd();
                    dVar.getSupportFragmentManager().m().e(zzdVar2, "SupportLifecycleFragmentImpl").h();
                }
