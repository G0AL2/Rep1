...
final class zzzf extends zzxt implements RandomAccess, zzaax {
    private static final zzzf zza;
    private float[] zzb;
    private int zzc;

    static {
        zzzf zzzfVar = new zzzf(new float[0], 0);
        zza = zzzfVar;
        zzzfVar.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        zza();
        zzzr.zze(collection);
        if (!(collection instanceof zzzf)) {
            return super.addAll(collection);
        }
        zzzf zzzfVar = (zzzf) collection;
        int i10 = zzzfVar.zzc;
        if (i10 == 0) {
            return false;
        }
        ...
        if (Api.BaseClientBuilder.API_PRIORITY_OTHER - i11 >= i10) {
            ...
            System.arraycopy(zzzfVar.zzb, 0, this.zzb, this.zzc, zzzfVar.zzc);
            this.zzc = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzzfVar.zzc) {
            return false;
        }
        float[] fArr = zzzfVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzzq zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzzf(Arrays.copyOf(this.zzb, i10), this.zzc);
        }
    ...
    private zzzf(float[] fArr, int i10) {
        this.zzb = fArr;
        this.zzc = i10;
    }
