...
public abstract class zzaj extends zzag implements List, RandomAccess {
    private static final zzam zza = new zzah(zzak.zza, 0);
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzaj subList(int i10, int i11) {
        zzw.zzc(i10, i11, size());
        int i12 = i11 - i10;
        if (i12 == size()) {
            return this;
        }
        ...
        return new zzai(this, i10, i12);
    }

    @Override // java.util.List
    /* renamed from: zzh */
    public final zzam listIterator(int i10) {
        zzw.zzb(i10, size(), "index");
        return isEmpty() ? zza : new zzah(this, i10);
    }
}
