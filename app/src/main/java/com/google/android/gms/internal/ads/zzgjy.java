...
final class zzgjy {
    ...
    private zzgjy(zzgjx zzgjxVar) {
        zzgla.zzf(zzgjxVar, "output");
        this.zza = zzgjxVar;
        zzgjxVar.zze = this;
    }

    public static zzgjy zza(zzgjx zzgjxVar) {
        zzgjy zzgjyVar = zzgjxVar.zze;
        return zzgjyVar != null ? zzgjyVar : new zzgjy(zzgjxVar);
    }
    ...
    public final void zzB(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                ...
                i12 += zzgjx.zzE((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
                zzgjx zzgjxVar = this.zza;
                int intValue2 = ((Integer) list.get(i11)).intValue();
                zzgjxVar.zzs((intValue2 >> 31) ^ (intValue2 + intValue2));
                i11++;
            }
            return;
        }
        while (i11 < list.size()) {
            zzgjx zzgjxVar2 = this.zza;
            int intValue3 = ((Integer) list.get(i11)).intValue();
            zzgjxVar2.zzr(i10, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i11++;
        }
    }
    ...
    public final void zzD(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                ...
                i12 += zzgjx.zzF((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
                zzgjx zzgjxVar = this.zza;
                long longValue2 = ((Long) list.get(i11)).longValue();
                zzgjxVar.zzu((longValue2 >> 63) ^ (longValue2 + longValue2));
                i11++;
            }
            return;
        }
        while (i11 < list.size()) {
            ...
            zzgjxVar2.zzt(i10, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i11++;
        }
    }
    ...
    public final void zzI(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzgjx.zzE(((Integer) list.get(i13)).intValue());
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
    ...
    public final void zzK(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzgjx.zzF(((Long) list.get(i13)).longValue());
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
    ...
    public final void zzc(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            this.zza.zzs(i12);
            while (i11 < list.size()) {
                this.zza.zzO(((Boolean) list.get(i11)).booleanValue() ? (byte) 1 : (byte) 0);
                i11++;
            }
            return;
        }
    ...
    public final void zzd(int i10, zzgji zzgjiVar) throws IOException {
        this.zza.zzQ(i10, zzgjiVar);
    }

    public final void zze(int i10, List list) throws IOException {
        for (int i11 = 0; i11 < list.size(); i11++) {
            this.zza.zzQ(i10, (zzgji) list.get(i11));
        }
    }
    ...
    public final void zzj(int i10, List list, boolean z10) throws IOException {
        ...
        if (z10) {
            ...
            int i12 = 0;
            for (int i13 = 0; i13 < list.size(); i13++) {
                i12 += zzgjx.zzy(((Integer) list.get(i13)).intValue());
            }
            this.zza.zzs(i12);
            while (i11 < list.size()) {
    ...
    public final void zzq(int i10, Object obj, zzgmt zzgmtVar) throws IOException {
        zzgjx zzgjxVar = this.zza;
        zzgjxVar.zzq(i10, 3);
        zzgmtVar.zzn((zzgma) obj, zzgjxVar.zze);
        zzgjxVar.zzq(i10, 4);
    }
    ...
    public final void zzv(int i10, Object obj, zzgmt zzgmtVar) throws IOException {
        this.zza.zzn(i10, (zzgma) obj, zzgmtVar);
    }
