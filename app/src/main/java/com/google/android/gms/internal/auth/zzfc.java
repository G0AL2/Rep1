...
final class zzfc extends zzfe {
    ...
    public final void zza(Object obj, long j10) {
        ...
        zzgz.zzp(obj, j10, unmodifiableList);
    }
    ...
    public final <E> void zzb(Object obj, Object obj2, long j10) {
        ArrayList arrayList;
        List list = (List) zzgz.zzf(obj2, j10);
        int size = list.size();
        List list2 = (List) zzgz.zzf(obj, j10);
        if (list2.isEmpty()) {
