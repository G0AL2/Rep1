...
public class b {
    ...
    private static final ThreadLocal<Matrix> f22480a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f22481b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f22480a;
        ...
        ThreadLocal<RectF> threadLocal2 = f22481b;
