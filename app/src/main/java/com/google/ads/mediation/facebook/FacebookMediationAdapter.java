...
public class FacebookMediationAdapter extends RtbAdapter {
    ...
    private k7.a banner;
    private k7.b interstitial;
    private k7.c nativeAd;
    private c rewardedAd;
    private d rewardedInterstitialAd;

    /* loaded from: classes2.dex */
    class a implements a.InterfaceC0276a {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ InitializationCompleteCallback f20537a;

        a(FacebookMediationAdapter facebookMediationAdapter, InitializationCompleteCallback initializationCompleteCallback) {
            this.f20537a = initializationCompleteCallback;
        }

        @Override // com.google.ads.mediation.facebook.a.InterfaceC0276a
        public void a(AdError adError) {
            this.f20537a.onInitializationFailed(adError.getMessage());
        }

        @Override // com.google.ads.mediation.facebook.a.InterfaceC0276a
        public void b() {
            this.f20537a.onInitializationSucceeded();
        }
    }
    ...
    public void initialize(Context context, InitializationCompleteCallback initializationCompleteCallback, List<MediationConfiguration> list) {
        ...
        if (arrayList.isEmpty()) {
            ...
            com.google.ads.mediation.facebook.a.a().c(context, arrayList, new a(this, initializationCompleteCallback));
        }
    }

    @Override // com.google.android.gms.ads.mediation.Adapter
    public void loadBannerAd(MediationBannerAdConfiguration mediationBannerAdConfiguration, MediationAdLoadCallback<MediationBannerAd, MediationBannerAdCallback> mediationAdLoadCallback) {
        k7.a aVar = new k7.a(mediationBannerAdConfiguration, mediationAdLoadCallback);
        this.banner = aVar;
        aVar.a();
    }
    ...
    public void loadInterstitialAd(MediationInterstitialAdConfiguration mediationInterstitialAdConfiguration, MediationAdLoadCallback<MediationInterstitialAd, MediationInterstitialAdCallback> mediationAdLoadCallback) {
        k7.b bVar = new k7.b(mediationInterstitialAdConfiguration, mediationAdLoadCallback);
    ...
    public void loadNativeAd(MediationNativeAdConfiguration mediationNativeAdConfiguration, MediationAdLoadCallback<UnifiedNativeAdMapper, MediationNativeAdCallback> mediationAdLoadCallback) {
        k7.c cVar = new k7.c(mediationNativeAdConfiguration, mediationAdLoadCallback);
        this.nativeAd = cVar;
        cVar.f();
    }
