...
public final class j {
    ...
    private static final Map<Class<?>, Class<?>> f23881a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f23882b;
    ...
    static {
        ...
        f23881a = Collections.unmodifiableMap(hashMap);
        f23882b = Collections.unmodifiableMap(hashMap2);
    }
    ...
    public static boolean b(Type type) {
        return f23881a.containsKey(type);
    }

    public static <T> Class<T> c(Class<T> cls) {
        Class<T> cls2 = (Class<T>) f23881a.get(a.b(cls));
