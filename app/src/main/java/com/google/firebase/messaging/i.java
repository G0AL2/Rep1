...
public abstract class i extends Service {
    ...
    final ExecutorService executor = o.b();
    ...
    public static /* synthetic */ void a(i iVar, Intent intent, Task task) {
        iVar.lambda$onStartCommand$1(intent, task);
    }

    public static /* synthetic */ void b(i iVar, Intent intent, TaskCompletionSource taskCompletionSource) {
        iVar.lambda$processIntent$0(intent, taskCompletionSource);
    }
    ...
    public final int onStartCommand(final Intent intent, int i10, int i11) {
        ...
        processIntent.addOnCompleteListener(h.f23507a, new OnCompleteListener() { // from class: com.google.firebase.messaging.f
