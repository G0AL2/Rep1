...
public class h0 {
    ...
    private final Bundle f23508a;

    public h0(Bundle bundle) {
        Objects.requireNonNull(bundle, "data");
        this.f23508a = new Bundle(bundle);
    }
    ...
    private String w(String str) {
        if (!this.f23508a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f23508a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f23508a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f23508a);
        for (String str : this.f23508a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
