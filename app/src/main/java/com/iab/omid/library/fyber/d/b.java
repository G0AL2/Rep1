...
public class b {
    ...
    private static WindowManager f24074b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f24075c = {"x", "y", "width", "height"};

    /* renamed from: a  reason: collision with root package name */
    static float f24073a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24073a = context.getResources().getDisplayMetrics().density;
            f24074b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        a b10 = b(jSONObject);
        try {
            jSONObject.put("width", b10.f24076a);
            jSONObject.put("height", b10.f24077b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }

    public static void a(JSONObject jSONObject, a.C0319a c0319a) {
        com.iab.omid.library.fyber.b.c a10 = c0319a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0319a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f24074b != null) {
                ...
                f24074b.getDefaultDisplay().getRealSize(point);
                f11 = a(point.x);
                f10 = a(point.y);
            }
            f10 = 0.0f;
