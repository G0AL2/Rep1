...
public class b {
    ...
    private static WindowManager f24190b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f24191c = {"x", "y", "width", "height"};

    /* renamed from: a  reason: collision with root package name */
    static float f24189a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24189a = context.getResources().getDisplayMetrics().density;
            f24190b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        a b10 = b(jSONObject);
        try {
            jSONObject.put("width", b10.f24192a);
            jSONObject.put("height", b10.f24193b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0322a c0322a) {
        com.iab.omid.library.inmobi.b.c a10 = c0322a.a();
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f24190b != null) {
                ...
                f24190b.getDefaultDisplay().getRealSize(point);
                f11 = a(point.x);
                f10 = a(point.y);
            }
            f10 = 0.0f;
