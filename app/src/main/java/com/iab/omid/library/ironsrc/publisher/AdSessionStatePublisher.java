...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.ironsrc.e.b f24308a;

    /* renamed from: b  reason: collision with root package name */
    private AdEvents f24309b;

    /* renamed from: c  reason: collision with root package name */
    private MediaEvents f24310c;
    ...
    public AdSessionStatePublisher() {
        i();
        this.f24308a = new com.iab.omid.library.ironsrc.e.b(null);
    }
    ...
    public void a(WebView webView) {
        this.f24308a = new com.iab.omid.library.ironsrc.e.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f24309b = adEvents;
    }
    ...
    public void a(String str, long j10) {
        if (j10 >= this.f24312e) {
            this.f24311d = a.AD_STATE_VISIBLE;
    ...
    public void i() {
        this.f24312e = com.iab.omid.library.ironsrc.d.d.a();
        this.f24311d = a.AD_STATE_IDLE;
    }
}
