...
public class b {
    ...
    private static WindowManager f23956b;

    /* renamed from: c  reason: collision with root package name */
    private static String[] f23957c = {"x", "y", "width", "height"};

    /* renamed from: a  reason: collision with root package name */
    static float f23955a = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23955a = context.getResources().getDisplayMetrics().density;
            f23956b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        a b10 = b(jSONObject);
        try {
            jSONObject.put("width", b10.f23958a);
            jSONObject.put("height", b10.f23959b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0316a c0316a) {
        com.iab.omid.library.applovin.b.c a10 = c0316a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0316a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            if (f23956b != null) {
                ...
                f23956b.getDefaultDisplay().getRealSize(point);
                f11 = a(point.x);
                f10 = a(point.y);
            }
            f10 = 0.0f;
