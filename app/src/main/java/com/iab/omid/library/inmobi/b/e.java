...
public class e {
    ...
    private static e f24168a = new e();
    ...
    void a(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.inmobi.d.c.a("The WebView is null for " + str);
            return;
        }
    ...
    void a(final WebView webView, StringBuilder sb2) {
        final String sb3 = sb2.toString();
        Handler handler = webView.getHandler();
        if (handler == null || Looper.myLooper() == handler.getLooper()) {
            webView.loadUrl(sb3);
        } else {
            handler.post(new Runnable() { // from class: com.iab.omid.library.inmobi.b.e.1
