...
class c {
    ...
    private static final Pattern f24178a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f24179b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* renamed from: c  reason: collision with root package name */
    private static final Pattern f24180c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f24181d = Pattern.compile("<(body)( [^>]*?)?/>", 2);

    /* renamed from: e  reason: collision with root package name */
    private static final Pattern f24182e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* renamed from: f  reason: collision with root package name */
    private static final Pattern f24183f = Pattern.compile("<(html)( [^>]*?)?/>", 2);

    /* renamed from: g  reason: collision with root package name */
    private static final Pattern f24184g = Pattern.compile("<!DOCTYPE [^>]*>", 2);
    ...
    static String b(String str, String str2) {
        ...
        if (!b(str, sb2, f24179b, str2, a10) && !a(str, sb2, f24178a, str2, a10) && !b(str, sb2, f24181d, str2, a10) && !a(str, sb2, f24180c, str2, a10) && !b(str, sb2, f24183f, str2, a10) && !a(str, sb2, f24182e, str2, a10) && !a(str, sb2, f24184g, str2, a10)) {
            return str2 + str;
        }
        return sb2.toString();
    }
