...
public class e {
    ...
    private static e f24052a = new e();
    ...
    void a(WebView webView, String str, Object... objArr) {
        if (webView == null) {
            com.iab.omid.library.fyber.d.c.a("The WebView is null for " + str);
            return;
        }
    ...
    void a(final WebView webView, StringBuilder sb2) {
        ...
        if (handler == null || Looper.myLooper() == handler.getLooper()) {
            ...
            handler.post(new Runnable() { // from class: com.iab.omid.library.fyber.b.e.1
