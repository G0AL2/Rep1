...
public class YogaNative {
    ...
    static native void jni_YGConfigSetPrintTreeFlagJNI(long j10, boolean z10);

    static native void jni_YGConfigSetShouldDiffLayoutWithoutLegacyStretchBehaviourJNI(long j10, boolean z10);
    ...
    static native void jni_YGNodeClearChildrenJNI(long j10);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static native void jni_YGNodeFreeJNI(long j10);
    ...
    static native void jni_YGNodeMarkDirtyAndPropogateToDescendantsJNI(long j10);
    ...
    static native void jni_YGNodePrintJNI(long j10);
