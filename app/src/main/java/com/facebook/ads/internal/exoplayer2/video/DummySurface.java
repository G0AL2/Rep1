...
public final class DummySurface extends Surface {
    ...
    public DummySurface(J5 j52, SurfaceTexture surfaceTexture, boolean z10) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0027, code lost:
        if (A02(85, 6, 113).equals(com.facebook.ads.redexgen.X.C1020Iz.A06) != false) goto L7;
     */
    ...
    */
    public static int A00(android.content.Context r6) {
        /*
            ...
            r4 = 0
            if (r0 >= r5) goto L2a
            java.lang.String r3 = com.facebook.ads.redexgen.X.C1020Iz.A05
    ...
    public static DummySurface A01(Context context, boolean z10) {
        A03();
        IK.A04(!z10 || A05(context));
        return new J5().A04(z10 ? A03 : 0);
    }
    ...
    public static synchronized boolean A05(Context context) {
        ...
        synchronized (DummySurface.class) {
            z10 = true;
            if (!A04) {
                A03 = C1020Iz.A02 < 24 ? 0 : A00(context);
                A04 = true;
            }
            if (A03 == 0) {
                z10 = false;
