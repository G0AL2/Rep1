...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public final boolean equals(@Nullable Object obj) {
            if (obj instanceof SchemeData) {
                ...
                if (C1020Iz.A0g(this.A01, schemeData.A01) && C1020Iz.A0g(this.A02, schemeData.A02) && C1020Iz.A0g(this.A05, schemeData.A05) && Arrays.equals(this.A04, schemeData.A04)) {
                    return true;
                }
                return false;
            }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (C1020Iz.A0g(this.A02, drmInitData.A02) && Arrays.equals(this.A03, drmInitData.A03)) {
            return true;
        }
        return false;
    }
