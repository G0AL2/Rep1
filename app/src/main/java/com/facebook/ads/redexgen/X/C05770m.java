...
import com.facebook.ads.redexgen.X.C05770m;
...
public final class C05770m {
    ...
    public final InterfaceC1028Jh A05;
    public long A00 = 0;
    @Nullable
    public String A04 = null;
    @Nullable
    public EnumC05700e A02 = null;
    ...
    public C05770m(InterfaceC1028Jh interfaceC1028Jh, Activity activity, int i10) {
        this.A05 = interfaceC1028Jh;
    ...
    @Nullable
    public static C05770m A00(InterfaceC1028Jh interfaceC1028Jh, @Nullable Activity activity) {
        return A01(interfaceC1028Jh, activity, Build.VERSION.SDK_INT);
    }

    @Nullable
    @VisibleForTesting
    public static C05770m A01(InterfaceC1028Jh interfaceC1028Jh, @Nullable Activity activity, int i10) {
        if (activity != null && i10 >= 14) {
            return new C05770m(interfaceC1028Jh, activity, i10);
        }
        return null;
    }

    private void A04(String str, long j10, long j11, @Nullable EnumC05700e enumC05700e) {
        HashMap hashMap = new HashMap();
        hashMap.put(A02(9, 10, 8), Long.toString(j10));
        hashMap.put(A02(0, 9, 34), Long.toString(j11));
        if (enumC05700e != null) {
            hashMap.put(A02(19, 7, 9), enumC05700e.name());
        }
    ...
    public final void A06(@Nullable EnumC05700e enumC05700e) {
        this.A02 = enumC05700e;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC05700e enumC05700e = EnumC05700e.A03;
        if (A07[2].charAt(6) == '9') {
