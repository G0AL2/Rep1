...
public final class C1020Iz {
    ...
    public static int A09(byte[] bArr, int i10, int i11, int i12) {
        while (i10 < i11) {
            i12 = (i12 << 8) ^ A0A[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255];
            i10++;
        }
        return i12;
    }
    ...
    public static long A0F(long multiplicationFactor, long j10, long j11) {
        if (j11 >= j10 && j11 % j10 == 0) {
            long divisionFactor = multiplicationFactor / (j11 / j10);
            return divisionFactor;
        } else if (j11 < j10 && j10 % j11 == 0) {
            return multiplicationFactor * (j10 / j11);
        } else {
            double d10 = j10;
            String[] strArr = A01;
            if (strArr[1].charAt(11) != strArr[2].charAt(11)) {
            ...
            return (long) (multiplicationFactor * (d10 / j11));
        }
    }

    public static long A0G(long result, long j10, long j11) {
        long j12 = result + j10;
        if (((result ^ j12) & (j10 ^ j12)) < 0) {
            return j11;
        }
        return j12;
    }

    public static long A0H(long result, long j10, long j11) {
        long j12 = result - j10;
        if (((result ^ j10) & (result ^ j12)) < 0) {
            return j11;
        }
        return j12;
    }

    public static long A0I(long maxPositionUs, C0831Ax c0831Ax, long j10, long j11) {
        if (C0831Ax.A04.equals(c0831Ax)) {
            return maxPositionUs;
        }
        long A0H = A0H(maxPositionUs, c0831Ax.A01, Long.MIN_VALUE);
        long A0G = A0G(maxPositionUs, c0831Ax.A00, Long.MAX_VALUE);
        boolean z10 = true;
        boolean z11 = A0H <= j10 && j10 <= A0G;
        z10 = (A0H > j11 || j11 > A0G) ? false : false;
        if (z11 && z10) {
            if (Math.abs(j10 - maxPositionUs) <= Math.abs(j11 - maxPositionUs)) {
                return j10;
            }
            return j11;
        } else if (z11) {
    ...
    public static String A0O(String str) {
        ...
        int i10 = 0;
        for (int i11 = 0; i11 < percentCharacterCount; i11++) {
            if (str.charAt(i11) == '%') {
                i10++;
            }
        }
        ...
        int i12 = percentCharacterCount - (i10 * 2);
        StringBuilder sb2 = new StringBuilder(i12);
        Matcher matcher = A07.matcher(str);
        int i13 = 0;
        while (i10 > 0 && matcher.find()) {
            int startOfNotEscaped = Integer.parseInt(matcher.group(1), 16);
            char c10 = (char) startOfNotEscaped;
            int startOfNotEscaped2 = matcher.start();
            sb2.append((CharSequence) str, i13, startOfNotEscaped2);
            sb2.append(c10);
            i13 = matcher.end();
            i10--;
        }
        if (i13 < percentCharacterCount) {
            sb2.append((CharSequence) str, i13, percentCharacterCount);
        }
    ...
    public static ExecutorService A0T(String str) {
        return Executors.newSingleThreadExecutor(new ThreadFactoryC1019Iy(str));
    }
    ...
    public static void A0W(InterfaceC0975He interfaceC0975He) {
    ...
    */
    public static byte[] A0h(java.lang.String r6) {
        ...
        L2b:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1020Iz.A0h(java.lang.String):byte[]");
    }
