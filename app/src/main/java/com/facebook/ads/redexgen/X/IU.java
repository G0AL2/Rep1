...
public final class IU implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new IS(C1020Iz.A0P(A04(0, 67, 11), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static EGLDisplay A02() {
        ...
        if (!EGL14.eglInitialize(display, iArr, 0, iArr, 1)) {
            throw new IS(A04(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 20, 105));
        }
        return display;
    }
