...
public class F8 extends C1587cA {
    public final /* synthetic */ AbstractC1573bv A00;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public F8(AbstractC1573bv abstractC1573bv, Context context) {
        super(context);
        this.A00 = abstractC1573bv;
    }
    ...
    public final void A0I(View view, C06744i c06744i, C06704e c06704e) {
        AbstractC1573bv abstractC1573bv = this.A00;
        int[] A0H = abstractC1573bv.A0H(abstractC1573bv.A00.getLayoutManager(), view);
        int i10 = A0H[0];
        int i11 = A0H[1];
