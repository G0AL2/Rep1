...
public final class C9O {
    ...
    public static long A01(C8U c8u) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                c8u.A06().A8y(A02(144, 7, 117), C07828z.A1E, new AnonymousClass90(e10));
            }
            return -1L;
        }
    }
    ...
    public static boolean A08() {
        ...
        if (!str.contains(A022) && !Build.FINGERPRINT.startsWith(A02(DownloadResource.STATUS_WAITING_FOR_NETWORK, 7, 93))) {
