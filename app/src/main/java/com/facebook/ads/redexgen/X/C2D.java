...
public final class C2D {
    ...
    public static List<C2H> A04(String str) throws JSONException {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            ...
            C2H c2h = new C2H(jSONObject.getInt(A02(IronSourceError.ERROR_BN_LOAD_AFTER_LONG_INITIATION, 12, 123)), jSONObject.getString(A02(590, 11, 33)), jSONObject.optString(A02(366, 16, 17)));
    ...
    public static Map<String, String> A05(@Nullable String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C07828z.A27, new AnonymousClass90(A02(239, 20, 101)));
                return null;
            } else if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C07828z.A24, new AnonymousClass90(A02(221, 18, 10)));
                return null;
            } else {
                return hashMap;
            }
        } catch (JSONException e10) {
            A08(C07828z.A26, new AnonymousClass90(e10));
            return null;
        }
    }

    private final void A07() {
        C2I A57 = this.A00.A57();
        A57.ADR(A02(518, 22, 120), 0L);
        A57.A3N();
    }

    public static void A08(int i10, AnonymousClass90 anonymousClass90) {
        C1399Xx A00 = C8T.A00();
        if (A00 != null) {
            A00.A06().A8y(A02(687, 9, 5), i10, anonymousClass90);
        }
    }
    ...
    public final C2H A0A() {
        ...
        try {
            ...
            A07();
            A08(C07828z.A25, new AnonymousClass90(e10));
        }
        return c2h;
    }
    ...
    public final C2H A0B() {
        ...
        try {
            ...
            A07();
            A08(C07828z.A28, new AnonymousClass90(e10));
        }
        return c2h;
    }
    ...
    public final String A0H() {
        return A03(A02(452, 7, 20), A02(DownloadResource.STATUS_PAUSED_BY_APP, 7, 27));
    }
    ...
    public final boolean A0O(Context context, boolean z10) {
        return (z10 || JR.A1p(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
