...
public class RunnableC0922Fd implements Runnable {
    ...
    public RunnableC0922Fd(C0930Fl c0930Fl, InterfaceC0933Fo interfaceC0933Fo, C0931Fm c0931Fm, C0932Fn c0932Fn) {
        this.A00 = c0930Fl;
