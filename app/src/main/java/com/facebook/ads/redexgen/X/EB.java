...
public final class EB {
    ...
    static {
        ...
        A03.put(32, IronSourceError.ERROR_RV_LOAD_FAILED_NO_CANDIDATES);
        A03.put(40, 2048);
        A03.put(41, 4096);
        A03.put(42, Constants.BUFFER_SIZE);
        A03.put(50, 16384);
        A03.put(51, 32768);
        A03.put(52, Constants.MIN_PROGRESS_STEP);
        A07 = new HashMap();
        ...
        A07.put(A07(313, 4, 67), Integer.valueOf((int) IronSourceError.ERROR_RV_LOAD_FAILED_NO_CANDIDATES));
        A07.put(A07(317, 4, 23), 4096);
        A07.put(A07(321, 4, 77), 16384);
        A07.put(A07(325, 4, 19), Integer.valueOf((int) Constants.MIN_PROGRESS_STEP));
        ...
        A07.put(A07(DownloadResource.STATUS_PAUSED_BY_APP, 4, 50), Integer.valueOf((int) Constants.BUFFER_SIZE));
    ...
    public static int A00() throws E9 {
        if (A00 == -1) {
            ...
            if (A062 != null) {
                ...
                i10 = Math.max(i10, C1020Iz.A02 >= 21 ? 345600 : 172800);
            }
            A00 = i10;
        }
        return A00;
    ...
    */
    ...
    @Nullable
    public static E0 A06(String str, boolean z10) throws E9 {
        List<E0> A09 = A09(str, z10);
        if (A09.isEmpty()) {
            return null;
        }
        return A09.get(0);
    ...
    */
    ...
    public static synchronized List<E0> A09(String str, boolean z10) throws E9 {
        synchronized (EB.class) {
            E8 e82 = new E8(str, z10);
            List<E0> list = A06.get(e82);
            if (list != null) {
                return list;
            }
            EA c1339Vp = C1020Iz.A02 >= 21 ? new C1339Vp(z10) : new C1340Vq();
            ArrayList<E0> A082 = A08(e82, c1339Vp, str);
            if (z10 && A082.isEmpty() && 21 <= C1020Iz.A02 && C1020Iz.A02 <= 23) {
                c1339Vp = new C1340Vq();
                A082 = A08(e82, c1339Vp, str);
                if (!A082.isEmpty()) {
            ...
            if (A07(922, 14, 24).equals(str)) {
                E8 eac3Key = new E8(A07(912, 10, 114), e82.A01);
                A082.addAll(A08(eac3Key, c1339Vp, str));
            }
            A0B(A082);
            List<E0> unmodifiableList = Collections.unmodifiableList(A082);
            A06.put(e82, unmodifiableList);
            return unmodifiableList;
        }
    }

    public static void A0B(List<E0> list) {
        if (C1020Iz.A02 < 26 && list.size() > 1) {
            if (A07(583, 25, 60).equals(list.get(0).A02)) {
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        E0 e02 = list.get(i10);
                        if (A07(657, 22, 55).equals(e02.A02)) {
                            list.remove(i10);
                            list.add(0, e02);
                            return;
                        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:103:0x02e2, code lost:
        if (r6.equals(com.facebook.ads.redexgen.X.C1020Iz.A05) == false) goto L119;
     */
    /* JADX WARN: Code restructure failed: missing block: B:105:0x02f4, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(A07(com.ironsource.mediationsdk.logger.IronSourceError.ERROR_RV_ALL_SMASHES_SESSION_CAPPED, 8, 110)) != false) goto L118;
     */
    /* JADX WARN: Code restructure failed: missing block: B:107:0x0305, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(A07(com.ironsource.mediationsdk.logger.IronSourceError.ERROR_DO_IS_LOAD_ALREADY_IN_PROGRESS, 7, 106)) != false) goto L118;
     */
    /* JADX WARN: Code restructure failed: missing block: B:109:0x0316, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(A07(com.ironsource.mediationsdk.logger.IronSourceError.ERROR_IS_SHOW_CALLED_DURING_SHOW, 6, 14)) != false) goto L118;
     */
    /* JADX WARN: Code restructure failed: missing block: B:111:0x0327, code lost:
        if (A07(763, 6, 27).equals(com.facebook.ads.redexgen.X.C1020Iz.A03) != false) goto L118;
     */
    /* JADX WARN: Code restructure failed: missing block: B:113:0x0339, code lost:
        if (A07(966, 12, 93).equals(com.facebook.ads.redexgen.X.C1020Iz.A03) != false) goto L118;
     */
    /* JADX WARN: Code restructure failed: missing block: B:115:0x034a, code lost:
        if (A07(55, 5, 67).equals(com.facebook.ads.redexgen.X.C1020Iz.A03) != false) goto L118;
     */
    /* JADX WARN: Code restructure failed: missing block: B:117:0x035b, code lost:
        if (A07(757, 6, 43).equals(com.facebook.ads.redexgen.X.C1020Iz.A03) != false) goto L118;
     */
    /* JADX WARN: Code restructure failed: missing block: B:119:0x036c, code lost:
        if (A07(769, 5, 127).equals(com.facebook.ads.redexgen.X.C1020Iz.A03) == false) goto L119;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:124:0x037f, code lost:
        r3 = com.facebook.ads.redexgen.X.C1020Iz.A02;
        r4 = A07(961, 5, 78);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:129:0x03a4, code lost:
        if (r6.equals(com.facebook.ads.redexgen.X.C1020Iz.A05) == false) goto L136;
     */
    /* JADX WARN: Code restructure failed: missing block: B:131:0x03b5, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(A07(944, 2, 62)) != false) goto L135;
     */
    /* JADX WARN: Code restructure failed: missing block: B:133:0x03c6, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(A07(997, 7, 77)) != false) goto L135;
     */
    /* JADX WARN: Code restructure failed: missing block: B:135:0x03ce, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(r4) != false) goto L135;
     */
    /* JADX WARN: Code restructure failed: missing block: B:137:0x03df, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(A07(991, 6, 10)) != false) goto L135;
     */
    /* JADX WARN: Code restructure failed: missing block: B:139:0x03f0, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(A07(com.ironsource.mediationsdk.logger.IronSourceError.AUCTION_ERROR_EMPTY_WATERFALL, 2, 88)) == false) goto L136;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:142:0x03f5, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A02 > 19) goto L143;
     */
    /* JADX WARN: Code restructure failed: missing block: B:144:0x03fd, code lost:
        if (com.facebook.ads.redexgen.X.C1020Iz.A03.startsWith(r4) == false) goto L143;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:77:0x022e, code lost:
        if (A07(774, 6, 99).equals(com.facebook.ads.redexgen.X.C1020Iz.A03) != false) goto L78;
     */
    /* JADX WARN: Code restructure failed: missing block: B:92:0x028c, code lost:
        if (A07(85, 5, 32).equals(com.facebook.ads.redexgen.X.C1020Iz.A03) != false) goto L91;
     */
