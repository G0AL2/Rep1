...
public class C06965e {
    ...
    public C06965e(String str, String str2, @Nullable String str3, boolean z10, @Nullable String str4) {
        this.A03 = str;
        this.A02 = str2;
        this.A01 = str3;
        this.A04 = z10;
    ...
    public static C06965e A00(JSONObject jSONObject) throws JSONException {
        return new C06965e(jSONObject.getString(A01(30, 3, 81)), jSONObject.getString(A01(26, 4, 105)), jSONObject.optString(A01(5, 9, 70)), jSONObject.getString(A01(14, 8, 105)).equals(A01(22, 4, 106)), jSONObject.optString(A01(0, 5, 91)));
    }
}
