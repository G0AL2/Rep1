...
public final class C1379Xd implements InterfaceC07698k {
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC07698k
    public final void A9b(InterfaceC07688j interfaceC07688j) {
        String[] stringArray;
        Integer integer;
        Integer state;
        ...
        interfaceC07688j.ACI(stringArray, integer, state);
    }
}
