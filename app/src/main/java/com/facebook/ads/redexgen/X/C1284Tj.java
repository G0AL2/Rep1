...
public final class C1284Tj implements MY {
    ...
    */
    public static void A00(int[] r42, int r43, int r44, int r45, int r46, int r47, int r48) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1284Tj.A00(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A02(Bitmap bitmap, float f10) {
        ...
        try {
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                int i12 = height;
                arrayList.add(new CallableC1096Mc(currentPixels, cores, i12, (int) f10, i10, i11, 1));
                height = i12;
                arrayList2.add(new CallableC1096Mc(currentPixels, cores, height, (int) f10, i10, i11, 2));
            }
            try {
                C1097Md.A01.invokeAll(arrayList);
                try {
                    C1097Md.A01.invokeAll(arrayList2);
                    try {
