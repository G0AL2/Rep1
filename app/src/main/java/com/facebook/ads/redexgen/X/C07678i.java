...
public final class C07678i {
    ...
    public C07678i(Set<String> options, @Nullable Integer num, @Nullable Integer num2, String str) {
        this.A03 = options;
        this.A00 = num;
        this.A01 = num2;
        this.A02 = str;
    ...
    public C07678i(@Nullable String[] strArr, @Nullable Integer num, @Nullable Integer num2) {
    ...
    @Nullable
    public static C07678i A00(@Nullable String str) {
        if (str == null) {
            return null;
        }
        ...
        return new C07678i(linkedHashSet, num, num2, str);
    }
    ...
    private String A01() {
        ...
        for (String str : this.A03) {
            ...
            sb2.append(String.format(locale, A02, option, this.A00, this.A01));
        }
        return sb2.toString();
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        if (obj instanceof C07678i) {
            C07678i c07678i = (C07678i) obj;
            ...
            A06[0] = "YHhc40Na8nm";
            Integer num2 = c07678i.A00;
            if (num == num2 || (num != null && num.equals(num2))) {
                Integer num3 = this.A01;
                Integer num4 = c07678i.A01;
                return (num3 == num4 || (num3 != null && num3.equals(num4))) && this.A03.equals(c07678i.A03);
            }
            return false;
        }
        return false;
