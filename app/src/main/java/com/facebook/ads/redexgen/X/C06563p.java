...
public class C06563p {
    ...
    private void A01() {
        if (this.A01 == null) {
            this.A01 = new C06563p();
        }
    }

    public final int A03(int i10) {
        C06563p c06563p = this.A01;
        if (c06563p == null) {
            if (i10 >= 64) {
            ...
            return c06563p.A03(i10 - 64) + Long.bitCount(this.A00);
        }
    }
    ...
    public final boolean A09(int i10) {
        ...
        this.A00 = (before & j11) | Long.rotateRight(before & ((-1) ^ j11), 1);
        C06563p c06563p = this.A01;
        if (c06563p != null) {
            if (c06563p.A08(0)) {
                A06(63);
