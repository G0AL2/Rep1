...
public final class C07919i implements Closeable {
    ...
    public C07919i(File file) throws IOException {
        ...
        this.A00 = new C07929j(readInt, readInt2);
    }
    ...
    public final C07929j A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C07929j c07929j) throws IOException {
        if (!this.A01) {
            if (c07929j.A02() >= 0 && c07929j.A03() >= 0) {
                this.A00 = c07929j;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 96), Integer.valueOf(c07929j.A02()), Integer.valueOf(c07929j.A03())));
        }
        throw new IOException(A00(0, 28, 58));
    }
