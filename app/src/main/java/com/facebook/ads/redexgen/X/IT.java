...
public final class IT implements QT {
    ...
    public IT(View view, int i10, int i11, int i12) {
        this.A05 = view;
        this.A02 = i10;
        this.A04 = i11;
        this.A03 = i12;
    ...
    private ValueAnimator A00(View view, int i10, int i11) {
        ...
        ofInt.addUpdateListener(new C1200Qc(this, view));
        return ofInt;
    }
    ...
    public void A08(boolean z10) {
        if (z10) {
            ...
            this.A00.addListener(new C1199Qb(this));
            this.A00.start();
            return;
        }
    ...
    public void A09(boolean z10) {
        ...
        if (z10) {
            ...
            this.A00.addListener(new C1198Qa(this));
            this.A00.start();
            return;
        }
        View view = this.A05;
