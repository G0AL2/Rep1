...
public final class C05890y extends BroadcastReceiver {
    ...
    public C05890y(C1400Xy c1400Xy, String str, C1672dc c1672dc, InterfaceC05880x interfaceC05880x) {
        this.A02 = c1400Xy;
        this.A03 = str;
        this.A01 = interfaceC05880x;
        this.A00 = c1672dc;
    }

    public final void A02() {
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(A00(DownloadResource.STATUS_HTTP_DATA_ERROR, 48, 29) + this.A03);
        ...
        intentFilter.addAction(A00(TTAdConstant.AD_ID_IS_NULL_CODE, 46, 38) + this.A03);
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (equals) {
            ...
            InterfaceC05880x interfaceC05880x = this.A01;
            C1672dc c1672dc = this.A00;
            if (A05[3].charAt(4) != 'D') {
                A05[0] = "TqpNublq1V6zWfVafs4QLB";
                interfaceC05880x.AB3(c1672dc);
                return;
            }
            ...
            InterfaceC05880x interfaceC05880x3 = this.A01;
            if (A05[7].charAt(0) != 'P') {
                throw new RuntimeException();
            }
            A05[0] = "2dNMpRkIvORsTqY7tSIXPx";
            interfaceC05880x3.AB8();
        }
    }
}
