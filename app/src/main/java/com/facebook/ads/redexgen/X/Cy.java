...
public final class Cy {
    ...
    public /* synthetic */ Cy(C1356Wg c1356Wg) {
        this();
    }

    public static Pair<String, List<byte[]>> A00(C1004Ij c1004Ij) throws C0813Af {
        try {
            c1004Ij.A0Z(16);
            ...
            if (A0K == 826496599) {
                ...
                for (int A06 = c1004Ij.A06() + 20; A06 < bArr.length - 4; A06++) {
    ...
    public static List<byte[]> A03(byte[] bArr) throws C0813Af {
        ...
        try {
            if (bArr[0] == 2) {
                ...
                int vorbisSkipLength = i10 + 1;
                int i12 = i11 + bArr[i10];
                int i13 = 0;
                while (bArr[vorbisSkipLength] == -1) {
                    i13 += 255;
                    vorbisSkipLength++;
                }
                int i14 = vorbisSkipLength + 1;
                int offset = bArr[vorbisSkipLength];
                int i15 = i13 + offset;
                int vorbisSkipLength2 = bArr[i14];
                if (vorbisSkipLength2 == 1) {
                    byte[] bArr2 = new byte[i12];
                    System.arraycopy(bArr, i14, bArr2, 0, i12);
                    int i16 = i14 + i12;
                    int vorbisSkipLength3 = bArr[i16];
                    if (vorbisSkipLength3 == 3) {
                        int i17 = i16 + i15;
                        int vorbisSkipLength4 = bArr[i17];
                        if (vorbisSkipLength4 == 5) {
                            int offset2 = bArr.length;
                            byte[] bArr3 = new byte[offset2 - i17];
                            int offset3 = bArr.length;
                            System.arraycopy(bArr, i17, bArr3, 0, offset3 - i17);
                            ArrayList arrayList = new ArrayList(2);
                            arrayList.add(bArr2);
                            arrayList.add(bArr3);
                            return arrayList;
                        }
                        throw new C0813Af(A01);
                    }
                    throw new C0813Af(A01);
                }
                throw new C0813Af(A01);
    ...
    public static boolean A05(C1004Ij c1004Ij) throws C0813Af {
        UUID uuid;
        UUID uuid2;
        try {
            int A0C = c1004Ij.A0C();
            ...
            if (A0C == 65534) {
                c1004Ij.A0Y(24);
                long A0L = c1004Ij.A0L();
                uuid = C1354We.A0s;
                if (A0L == uuid.getMostSignificantBits()) {
                    long A0L2 = c1004Ij.A0L();
                    uuid2 = C1354We.A0s;
            ...
            throw new C0813Af(A01(170, 34, 13));
        }
    }
    ...
    private byte[] A06() {
        ...
        int i10 = (this.A04 > (-1.0f) ? 1 : (this.A04 == (-1.0f) ? 0 : -1));
        String[] strArr = A0i;
        if (strArr[0].length() != strArr[5].length()) {
            String[] strArr2 = A0i;
            strArr2[2] = "mbc";
            strArr2[4] = "GijrUN633WOPM1ihGB7sVJQ0vA2mo6CS";
            if (i10 == 0 || this.A05 == -1.0f || this.A02 == -1.0f || this.A03 == -1.0f || this.A08 == -1.0f || this.A09 == -1.0f || this.A00 == -1.0f || this.A01 == -1.0f) {
                return null;
            }
    ...
    */
    public final void A09(com.facebook.ads.redexgen.X.InterfaceC0862Ce r28, int r29) throws com.facebook.ads.redexgen.X.C0813Af {
        /*
