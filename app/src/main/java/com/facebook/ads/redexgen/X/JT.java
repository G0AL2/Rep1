...
public final class JT {
    ...
    public static int A05(Context context) {
        return JR.A0O(context).A2B(A0L(IronSourceError.ERROR_RV_SHOW_CALLED_DURING_SHOW, 21, 19), 10);
    }
    ...
    public static int A07(Context context) {
        return JR.A0O(context).A2B(A0L(TTAdConstant.STYLE_SIZE_RADIO_2_3, 36, 33), 10485760);
    }
    ...
    public static int A0A(Context context) {
        return JR.A0O(context).A2B(A0L(TTAdConstant.DEEPLINK_FALLBACK_TYPE_CODE, 46, 99), 0);
    }
    ...
    public static int A0C(Context context) {
        return JR.A0O(context).A2B(A0L(DownloadResource.STATUS_UNHANDLED_HTTP_CODE, 41, 25), 0);
    }
    ...
    public static int A0H(Context context, String str, int i10) {
        int A2B = JR.A0O(context).A2B(str, i10);
        if (A2B >= 0 && A2B < 101) {
            return A2B;
        }
        return i10;
    ...
    public static long A0I(Context context) {
        return JR.A0O(context).A2C(A0L(320, 46, 122), Constants.MIN_PROGRESS_TIME);
    }

    public static long A0J(Context context) {
        return JR.A0O(context).A2B(A0L(IronSourceError.ERROR_IS_ALL_SMASHES_SESSION_CAPPED, 41, 66), c.COLLECT_MODE_FINANCE) * 1000;
    }

    public static long A0K(Context context) {
        return JR.A0O(context).A2C(A0L(IronSourceConstants.RV_CALLBACK_AVAILABILITY_TRUE, 34, 102), 500L);
    }

    public static HashMap<String, Integer> A0M(Context context) throws JSONException {
        String A2D = JR.A0O(context).A2D(A0L(24, 35, 123), A0L(22, 2, 109));
        HashMap<String, Integer> hashMap = new HashMap<>();
        JSONArray jSONArray = new JSONArray(A2D);
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            String blackListString = jSONArray.optString(i10);
