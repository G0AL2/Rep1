...
public final class C0997Ic {
    ...
    public static final ArrayList<C0996Ib> A02;
    ...
    */
    public static int A00(java.lang.String r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0997Ic.A00(java.lang.String):int");
    }
    ...
    public static int A01(String str) {
        ...
        if (A0B(str)) {
            ...
            A01[2] = "Tbf";
            return 2;
        } else if (A0A(str) || A04(23, 19, 49).equals(str) || A04(42, 19, 78).equals(str) || A04(DownloadResource.STATUS_PAUSED_BY_APP, 25, 9).equals(str) || A04(306, 20, 43).equals(str) || A04(110, 20, 74).equals(str) || A04(239, 28, 97).equals(str) || A04(218, 21, 14).equals(str) || A04(267, 19, 104).equals(str) || A04(130, 18, 103).equals(str) || A04(95, 15, 90).equals(str) || A04(61, 19, 98).equals(str)) {
            return 3;
        } else {
    ...
    public static int A02(String str) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            C0996Ib c0996Ib = A02.get(i10);
            if (str.equals(c0996Ib.A02)) {
                int i11 = c0996Ib.A00;
                if (A01[3].charAt(8) != '5') {
                    throw new RuntimeException();
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:78:0x0202, code lost:
        if (r3.startsWith(A04(com.ironsource.mediationsdk.logger.IronSourceError.ERROR_CODE_GENERIC, 4, 37)) == false) goto L65;
     */
    ...
    */
    public static java.lang.String A05(@androidx.annotation.Nullable java.lang.String r6) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0997Ic.A05(java.lang.String):java.lang.String");
    }
