...
public final class C1693dy implements C0G {
    ...
    public C1693dy(File file, C0B c0b) throws C1691dw {
        File file2;
        try {
            if (c0b != null) {
                this.A02 = c0b;
            ...
            throw new C1691dw(A00(186, 17, 126) + file + A00(0, 14, 84), e10);
        }
    }
    ...
    public final synchronized int A03() throws C1691dw {
        try {
        } catch (IOException e10) {
            throw new C1691dw(A00(137, 29, 81) + this.A00, e10);
        }
    ...
    public final synchronized void A05() throws C1691dw {
        try {
            this.A01.setLength(0L);
        } catch (IOException e10) {
            throw new C1691dw(A00(57, 16, 6), e10);
        }
    }

    public final synchronized void A06() throws C1691dw {
        try {
            this.A01.close();
            this.A02.AFC(this.A00);
        } catch (IOException e10) {
            throw new C1691dw(A00(104, 19, 99) + this.A00, e10);
        }
    }

    public final synchronized void A07() throws C1691dw {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (renamed) {
            ...
            try {
                ...
                throw new C1691dw(A00(123, 14, 124) + this.A00 + A00(0, 14, 84), e10);
            }
        }
        throw new C1691dw(A00(166, 20, 40) + this.A00 + A00(44, 4, 124) + file + A00(14, 16, 28));
    }

    public final synchronized void A08(byte[] bArr, int i10) throws C1691dw {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i10);
            } else {
                throw new C1691dw(A00(73, 31, 52) + this.A00 + A00(30, 14, 118));
            }
        } catch (IOException e10) {
            throw new C1691dw(String.format(Locale.US, A00(203, 53, 105), Integer.valueOf(i10), this.A01, Integer.valueOf(bArr.length)), e10);
        }
    }
