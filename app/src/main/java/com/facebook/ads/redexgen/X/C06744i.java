...
public class C06744i {
    ...
    public final void A04(int i10) {
        ...
        throw new IllegalStateException(A01(DownloadResource.STATUS_RUNNING, 30, 67) + Integer.toBinaryString(i10) + A01(0, 11, 52) + Integer.toBinaryString(this.A04));
    }
