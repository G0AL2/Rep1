...
public final class C1J {
    ...
    public static List<C1B> A01(JSONArray jSONArray, JSONObject jSONObject, C1400Xy c1400Xy, C1N c1n) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                c1400Xy.A06().A8y(A00(8, 7, 31), C07828z.A2A, new AnonymousClass90(e10));
            }
        }
        return arrayList;
    }
