...
public final class C1056Kl {
    public static C1056Kl A00;
    ...
    public static synchronized C1056Kl A00() {
        C1056Kl c1056Kl;
        synchronized (C1056Kl.class) {
            c1056Kl = A00;
        }
        return c1056Kl;
    }
    ...
    */
    private com.facebook.ads.redexgen.X.C1299Ty A01(com.facebook.ads.redexgen.X.C1400Xy r11, org.json.JSONObject r12, long r13) throws org.json.JSONException {
        /*
            r10 = this;
        ...
        L59:
            ...
            r0 = 0
            com.facebook.ads.redexgen.X.C1038Jr.A06(r11, r9, r13, r0)
            r2 = 19
            r1 = 7
            r0 = 39
            java.lang.String r0 = A04(r2, r1, r0)
        ...
        Lc1:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C1056Kl.A01(com.facebook.ads.redexgen.X.Xy, org.json.JSONObject, long):com.facebook.ads.redexgen.X.Ty");
    }

    private C1298Tx A02(JSONObject jSONObject) {
        return new C1298Tx(jSONObject.optString(A04(117, 7, 88), A04(0, 0, 87)), jSONObject.optInt(A04(47, 4, 116), 0), null);
    }

    private C1298Tx A03(JSONObject jSONObject) {
        try {
            ...
            return new C1298Tx(optString3, jSONObject.optInt(adReportingConfig2, 0), new C9H(A002, optString, optString2));
        } catch (JSONException unused) {
            return A02(jSONObject);
        }
    }

    public final C1058Kn A06(C1400Xy c1400Xy, String str, long j10) throws JSONException {
        if (!TextUtils.isEmpty(str)) {
            ...
            if (c10 == 0) {
                return A01(c1400Xy, jSONObject, j10);
            }
            if (c10 != 1) {
        ...
        return new C1058Kn(EnumC1057Km.A04);
    }
}
