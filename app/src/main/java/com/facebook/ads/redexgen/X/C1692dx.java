...
public final class C1692dx implements C0K {
    ...
    static {
        A04();
        A07 = C1692dx.class.getSimpleName();
    }

    public C1692dx(String str) {
        this(str, C0I.A01(str));
    }

    public C1692dx(String str, int i10) {
        this(str);
        this.A00 = i10;
    }

    public C1692dx(String str, @Nullable String str2) {
    ...
    private HttpURLConnection A02(int i10, int i11) throws IOException, C1694dz {
        String A01;
        ...
        do {
            ...
            if (i10 > 0) {
                httpURLConnection.setRequestProperty(A01(IronSourceConstants.INTERSTITIAL_DAILY_CAPPED, 5, 60), A01(322, 6, 127) + i10 + A01(50, 1, 18));
            }
            if (i11 > 0) {
            ...
            if (code > 5) {
                throw new C1694dz(A01(293, 20, 106) + code);
            }
        } while (z10);
        return httpURLConnection;
    }

    private void A03() throws C1694dz {
    ...
    private final void A05(int i10, int i11) throws C1694dz {
        try {
            this.A02 = A02(i10, i11);
            this.A06 = this.A02.getContentType();
            this.A01 = new BufferedInputStream(this.A02.getInputStream(), Constants.BUFFER_SIZE);
            this.A05 = A00(this.A02, i10, this.A02.getResponseCode());
        } catch (IOException e10) {
            throw new C1694dz(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i10, e10);
        }
    }
    ...
    public final void close() throws C1694dz {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C1694dz(A01(92, 37, 93), e10);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C0K
    public final synchronized int length() throws C1694dz {
    ...
    public final int read(byte[] bArr) throws C1694dz {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new GI(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e10);
            } catch (IOException e11) {
                throw new C1694dz(A01 + this.A03, e11);
            }
        }
        throw new C1694dz(A01 + this.A03 + A01(51, 23, 21));
    }
