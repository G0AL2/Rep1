...
public final class C1B implements Serializable {
    ...
    public static C1B A00(JSONObject jSONObject) {
        ...
        C1D A0I = new C1D().A0K(jSONObject.optString(A01(472, 9, 61))).A0H(jSONObject.optLong(A01(448, 24, 104), -1L)).A0F(optInt).A0E(jSONObject.optInt(A01(IronSourceConstants.INTERSTITIAL_DAILY_CAPPED, 18, 103), Api.BaseClientBuilder.API_PRIORITY_OTHER)).A0I(C1W.A01(jSONObject));
        JSONObject optJSONObject = jSONObject.optJSONObject(A01(168, 5, 84));
        if (optJSONObject != null) {
            C1D adMediaBuilder = A0I.A0J(optJSONObject.optString(A01(TTAdConstant.DEEPLINK_FALLBACK_TYPE_CODE, 3, 58)));
        ...
        c1b.A08(new C1M(C1091Lx.A04(jSONObject.optJSONArray(A01(123, 15, 103)))));
    ...
    public static String A02(JSONObject jSONObject) {
        ...
        if (delayText2.equals(delayText)) {
            JSONObject genericTextObject = jSONObject.optJSONObject(A01(IronSourceConstants.REWARDED_VIDEO_DAILY_CAPPED, 12, 14));
    ...
    public final void A0I(JSONObject jSONObject) {
        this.A00.A0M(jSONObject.optBoolean(A01(TTAdConstant.DOWNLOAD_URL_CODE, 22, 104)));
