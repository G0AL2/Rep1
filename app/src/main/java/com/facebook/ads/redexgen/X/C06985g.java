...
public final class C06985g {
    ...
    public final InterfaceC06975f A01;
    ...
    public C06985g(C7U c7u, JSONObject jSONObject, String str, String str2, boolean z10, InterfaceC06975f interfaceC06975f) {
        this.A02 = c7u;
        this.A05 = jSONObject;
        this.A03 = str;
        this.A04 = str2;
        this.A06 = z10 && A0A(this.A05);
        this.A01 = interfaceC06975f;
        this.A00 = new Handler(Looper.getMainLooper());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A09(boolean z10, C06965e c06965e) {
        String A03 = A03(6, 4, 28);
        String A032 = A03(15, 5, 66);
        String A033 = A03(10, 5, 52);
        if (z10) {
            boolean equals = A033.equals(c06965e.A02);
            ...
            if (equals) {
                this.A02.A0c(new C7S(c06965e.A03, -1, -1, this.A04, this.A03));
            } else if (A032.equals(c06965e.A02)) {
                this.A02.A0Z(new C7Q(c06965e.A03, this.A04, this.A03));
            } else if (!A03.equals(c06965e.A02)) {
            } else {
                this.A02.A0Y(new C7Q(c06965e.A03, this.A04, this.A03));
            }
        } else if (A033.equals(c06965e.A02)) {
            this.A02.A0b(new C7S(c06965e.A03, -1, -1, this.A04, this.A03));
        } else if (A032.equals(c06965e.A02)) {
            this.A02.A0a(new C7Q(c06965e.A03, this.A04, this.A03));
        } else if (!A03.equals(c06965e.A02)) {
        } else {
            this.A02.A0X(new C7Q(c06965e.A03, this.A04, this.A03));
        }
    }
    ...
    public final void A0B() {
        ...
        MX.A06.execute(new C1543bR(this));
    }
}
