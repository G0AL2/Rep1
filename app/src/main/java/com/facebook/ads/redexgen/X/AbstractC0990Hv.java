...
public abstract class AbstractC0990Hv implements RH {
    ...
    public final boolean AAl(RF rf) {
        R1 A00 = rf.A00();
        if (this.A00.A8Z()) {
            Log.e(AbstractC0990Hv.class.getSimpleName(), A00(14, 27, 78), rf);
        }
    ...
    @Override // com.facebook.ads.redexgen.X.RH
    public final void ADI(HttpURLConnection httpURLConnection, RD rd2, String str) throws IOException {
        httpURLConnection.setRequestMethod(rd2.A02());
        httpURLConnection.setDoOutput(rd2.A04());
        httpURLConnection.setDoInput(rd2.A03());
        if (str != null) {
