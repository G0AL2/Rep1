...
public final class JP {
    ...
    public JP(C1400Xy c1400Xy, String str, String str2) {
        this.A03 = c1400Xy;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A07(int i10, AnonymousClass90 anonymousClass90) {
        this.A03.A06().A8y(A05(189, 14, 74), i10, anonymousClass90);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A08(int i10, AnonymousClass90 anonymousClass90) {
        anonymousClass90.A03(1);
        this.A03.A06().A8z(A05(189, 14, 74), i10, anonymousClass90);
    }

    public final void A0C() {
        A08(C07828z.A1s, new AnonymousClass90(A05(101, 18, 66), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 125), A05(119, 51, 26));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(C07828z.A1o, new AnonymousClass90(A05(51, 50, 11)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e10) {
            A07(C07828z.A1n, new AnonymousClass90(e10));
        }
    }
}
