...
public final class N0 {
    ...
    public static View A00(C1400Xy c1400Xy, Throwable th) {
        A03(c1400Xy, th);
        return new View(c1400Xy);
    }

    public static void A03(C1400Xy c1400Xy, Throwable th) {
        c1400Xy.A06().A8y(A01(85, 15, 44), C07828z.A1v, new AnonymousClass90(th));
