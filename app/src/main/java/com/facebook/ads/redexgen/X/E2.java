...
public class E2 extends Exception {
    ...
    public E2(Format format, Throwable th, boolean z10, int i10) {
    ...
    public E2(Format format, Throwable th, boolean z10, String str) {
        super(A01(2, 21, 92) + str + A01(0, 2, 21) + format, th);
        this.A02 = format.A0O;
        this.A03 = z10;
        this.A00 = str;
        this.A01 = C1020Iz.A02 >= 21 ? A02(th) : null;
    }

    public static String A00(int i10) {
        String A01 = i10 < 0 ? A01(101, 4, 95) : A01(0, 0, 105);
        return A01(48, 53, 91) + A01 + Math.abs(i10);
    }
