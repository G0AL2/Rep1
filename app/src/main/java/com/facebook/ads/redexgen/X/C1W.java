...
public final class C1W implements Serializable {
    ...
    public C1W(String str, String str2, int i10, String str3, String str4, OH oh, int i11, boolean z10, boolean z11, C1X c1x, boolean z12, String str5) {
        if (z12) {
            this.A08 = UUID.randomUUID().toString();
            this.A07 = C1070La.A00(str).buildUpon().appendQueryParameter(A03(132, 11, 111), this.A08).appendQueryParameter(A03(58, 12, 69), str5).build().toString();
        } else {
            this.A07 = str;
            this.A08 = null;
        }
    ...
    public static C1W A01(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A03(DownloadResource.STATUS_INSUFFICIENT_SPACE_ERROR, 13, 62));
        if (optJSONObject == null) {
            return null;
        }
        return new C1W(optJSONObject.optString(A03(282, 3, 72)), optJSONObject.optString(A03(143, 19, 61)), A00(jSONObject), A05(optJSONObject), A04(optJSONObject), A02(optJSONObject), optJSONObject.optInt(A03(285, 32, 0), jh.DEFAULT_BITMAP_TIMEOUT), optJSONObject.optBoolean(A03(103, 17, 87), true), optJSONObject.optBoolean(A03(88, 15, 37)), C1X.A00(optJSONObject.optString(A03(211, 17, 50), A0F.name())), optJSONObject.optBoolean(A03(162, 25, 111)), jSONObject.optString(A03(70, 2, 71)));
    }
