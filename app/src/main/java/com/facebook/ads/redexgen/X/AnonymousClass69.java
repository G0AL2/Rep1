...
public final class AnonymousClass69 {
    ...
    public static EnumC07396w A0A(Context context) {
        return EnumC07396w.A00(JR.A0O(context).A2B(A0C(277, 5, 98), 0));
    }

    public static String A0B(int i10) {
        return A0C(282, 17, 90) + i10;
    }

    public static String A0D(Context context) {
        JR A0O = JR.A0O(context);
    ...
    public static String A0L(Context context, int i10) {
        JR A0O = JR.A0O(context);
        String A0B = A0B(i10);
        String A0C = A0C(355, 2, 84);
