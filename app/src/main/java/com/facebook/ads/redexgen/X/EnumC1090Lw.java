...
public enum EnumC1090Lw {
    ...
    EnumC1090Lw(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    public static EnumC1090Lw A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1090Lw[] values;
        for (EnumC1090Lw enumC1090Lw : values()) {
            if (enumC1090Lw.A01 == nativeComponentTag) {
                return enumC1090Lw;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1090Lw A00 = A00(nativeComponentTag);
        if (view != null && A00 != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC1090Lw enumC1090Lw) {
        if (view != null && enumC1090Lw != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC1090Lw);
        }
    }
