...
public final class VC implements InterfaceC0975He {
    ...
    public VC(Context context, @Nullable I0<? super VC> i02) {
    ...
    */
    public final long ACw(com.facebook.ads.redexgen.X.C0979Hi r9) throws com.facebook.ads.redexgen.X.HX {
        /*
            r8 = this;
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0975He
    public final int read(byte[] bArr, int i10, int i11) throws HX {
        if (i11 == 0) {
            return 0;
        }
        long j10 = this.A00;
