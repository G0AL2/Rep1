...
public abstract class AbstractC1696e1 implements C0B {
    ...
    static {
        A04();
        A03 = AbstractC1696e1.class.getSimpleName();
    }
    ...
    public static /* synthetic */ void A05(AbstractC1696e1 abstractC1696e1, File file) throws IOException {
        abstractC1696e1.A06(file);
    }
    ...
    public void AFC(File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC1696e1.A05(AbstractC1696e1.this, this.A00);
                return null;
            }
        });
    }
