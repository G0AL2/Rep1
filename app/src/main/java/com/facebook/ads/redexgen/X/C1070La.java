...
public final class C1070La {
    ...
    public static void A0B(String str, URI uri, Uri uri2) {
        ...
        if (!A0E) {
            A05 = A05 + String.format(Locale.US, A05(c.COLLECT_MODE_ML_MINIMIZE, 46, 37), uri.getScheme(), uri2.getScheme());
        }
        if (!A0E2) {
            A05 = A05 + String.format(Locale.US, A05(DownloadResource.STATUS_RUNNING, 56, 58), uri.getSchemeSpecificPart(), uri2.getSchemeSpecificPart());
        }
