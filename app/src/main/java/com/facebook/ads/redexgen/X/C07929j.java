...
public final class C07929j {
    ...
    public C07929j(int i10, int i11) {
        if (i10 < -1) {
    ...
    public final int A04(C07929j c07929j) {
        int i10 = this.A00;
        int i11 = c07929j.A00;
        if (i10 != i11) {
            return i10 - i11;
        }
        return this.A01 - c07929j.A01;
    }

    public final C07929j A05(int i10) {
        int i11 = this.A01;
        if (i10 + i11 >= 0) {
            return new C07929j(this.A00, i11 + i10);
        }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof C07929j) {
            C07929j c07929j = (C07929j) obj;
            int i10 = c07929j.A00;
            int i11 = this.A00;
            if (A03[4].charAt(2) != 'U') {
            ...
            return i10 == i11 && c07929j.A01 == this.A01;
        }
        return false;
    }
