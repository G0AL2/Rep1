...
public final class AnonymousClass67 {
    ...
    public String A01;
    @VisibleForTesting
    public final M3 A02 = new M3(300000000000L, new C1532bG(this));
    ...
    public static C9R A00(C1399Xx c1399Xx) {
        if (JR.A0v(c1399Xx)) {
    ...
    public void A02() {
        ...
        String A7Z = C9U.A00().A01(c1399Xx, true).A7Z(A00(c1399Xx));
        synchronized (this) {
            this.A01 = A7Z;
        }
    }
    ...
    public final synchronized String A06(C1399Xx c1399Xx) {
        this.A00 = c1399Xx;
        this.A00.A06().A9W();
