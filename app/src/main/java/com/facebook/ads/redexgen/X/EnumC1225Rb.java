...
public enum EnumC1225Rb {
    ...
    EnumC1225Rb(String str) {
        this.A00 = str;
    }

    public static EnumC1225Rb A00(String str) {
        EnumC1225Rb[] valuesCustom;
        for (EnumC1225Rb enumC1225Rb : valuesCustom()) {
            if (enumC1225Rb.A00.equals(str)) {
                return enumC1225Rb;
            }
        }
    ...
    public static EnumC1225Rb[] valuesCustom() {
        EnumC1225Rb[] enumC1225RbArr = (EnumC1225Rb[]) values().clone();
        String[] strArr = A02;
