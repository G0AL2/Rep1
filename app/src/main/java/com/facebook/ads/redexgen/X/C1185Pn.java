...
public final class C1185Pn {
    ...
    public static Map<String, String> A01(C8U c8u, String str, String str2) {
        ...
        int i10 = c8u.getResources().getDisplayMetrics().widthPixels;
        int i11 = c8u.getResources().getDisplayMetrics().heightPixels;
        hashMap.put(A00(105, 10, 61), c8u.A07().A02());
        hashMap.put(A00(56, 13, 37), str2);
        hashMap.put(A00(40, 16, 85), str);
        hashMap.put(A00(14, 12, 100), String.valueOf(anonymousClass99.A09()));
        hashMap.put(A00(82, 12, 26), String.valueOf((int) (i10 / Lr.A00)));
        hashMap.put(A00(69, 13, 61), String.valueOf((int) (i11 / Lr.A00)));
        hashMap.put(A00(32, 2, 124), c8u.A03().A7m());
        hashMap.put(A00(34, 6, 102), AnonymousClass99.A03);
        hashMap.put(A00(26, 6, 105), Locale.getDefault().toString());
        hashMap.put(A00(94, 11, 0), A00(0, 6, 127));
        hashMap.put(A00(6, 8, 60), anonymousClass99.A05());
        return hashMap;
    }
}
