...
public final class H9 {
    ...
    public H9(String str, int i10, String str2, String[] strArr) {
        this.A00 = i10;
        this.A01 = str;
        this.A02 = str2;
        this.A03 = strArr;
    ...
    public static H9 A01(String str, int i10) {
        String trim;
        String[] strArr;
        ...
        String[] A0l = C1020Iz.A0l(name, A02(1, 2, 40));
        String str2 = A0l[0];
        if (A0l.length > 1) {
        ...
        return new H9(str2, i10, trim, strArr);
    }
}
