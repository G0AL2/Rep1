...
public abstract class C3G extends E4 {
    ...
    public Format A07;
    public CL<C1372Ww> A08;
    public CL<C1372Ww> A09;
    public E0 A0A;
    ...
    public abstract int A1B(E6 e62, CM<C1372Ww> cm, Format format) throws E9;

    public abstract void A1N(E0 e02, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws E9;

    public abstract boolean A1P(long j10, long j11, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i10, int i11, long j12, boolean z10) throws AM;

    static {
        A0j();
        A0f = C1020Iz.A0h(A0Z(59, 76, 80));
    }
    ...
    public C3G(int i10, E6 e62, @Nullable CM<C1372Ww> cm, boolean z10) {
        super(i10);
        IK.A04(C1020Iz.A02 >= 16);
        this.A0a = (E6) IK.A01(e62);
        this.A0Z = cm;
        this.A0c = z10;
        this.A0X = new X2(0);
        this.A0Y = X2.A02();
    ...
    private int A0W(String str) {
        if (C1020Iz.A02 <= 25 && A0Z(263, 25, 64).equals(str)) {
            String str2 = C1020Iz.A06;
            if (A0e[5].charAt(22) != 'm') {
                String[] strArr = A0e;
                strArr[3] = "rXHSxRetqBcaMazmAuD1LrMN32rrN6yB";
                strArr[0] = "PYELojq5TDB6rkMOhN6BPW4xOGIFZ2Jw";
                if (str2.startsWith(A0Z(625, 7, 8)) || C1020Iz.A06.startsWith(A0Z(597, 7, 55)) || C1020Iz.A06.startsWith(A0Z(IronSourceError.ERROR_BN_LOAD_PLACEMENT_CAPPED, 7, 110)) || C1020Iz.A06.startsWith(A0Z(IronSourceError.ERROR_BN_INSTANCE_LOAD_EMPTY_SERVER_DATA, 7, 51))) {
                    return 2;
                }
            }
        ...
        if (C1020Iz.A02 < 24) {
            if (A0Z(338, 22, 88).equals(str) || A0Z(360, 29, 116).equals(str)) {
                if (!A0Z(683, 8, 33).equals(C1020Iz.A03)) {
                    String str3 = C1020Iz.A03;
                    String A0Z = A0Z(691, 12, 106);
                    String[] strArr2 = A0e;
                    if (strArr2[1].charAt(9) != strArr2[6].charAt(9)) {
                        A0e[7] = "EJTrH92MD698cCrSnGocCFo99KF41O7G";
                        if (!A0Z.equals(str3)) {
                            if (!A0Z(703, 7, 118).equals(C1020Iz.A03)) {
                                if (A0Z(732, 7, 17).equals(C1020Iz.A03)) {
                                    return 1;
                                }
                                return 0;
                            }
    ...
    public static MediaCodec.CryptoInfo A0Y(X2 x22, int i10) {
        MediaCodec.CryptoInfo A02 = x22.A02.A02();
        if (i10 == 0) {
            return A02;
        }
    ...
    private void A0k(E2 e22) throws AM {
        throw AM.A01(e22, A0y());
    }

    private boolean A0l() {
        if (A0Z(147, 6, 32).equals(C1020Iz.A05)) {
            if (!A0Z(139, 4, 90).equals(C1020Iz.A06)) {
                if (A0Z(135, 4, 82).equals(C1020Iz.A06)) {
                }
            }
            return true;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:95:0x01d8, code lost:
        com.facebook.ads.redexgen.X.C1000If.A0A(r12.A0X.A01);
     */
    ...
    */
    ...
    private boolean A0p(long j10, long j11) throws AM {
        boolean A1P;
        ...
        if (strArr[3].charAt(8) != strArr[0].charAt(8)) {
            ...
            if (z10 && this.A0K) {
                try {
                    A1P = A1P(j10, j11, this.A06, this.A0B, this.A04, this.A0V.flags, this.A0V.presentationTimeUs, this.A0P);
            ...
            if (A1P) {
                ...
                boolean z12 = (this.A0V.flags & 4) != 0;
                A0i();
                if (!z12) {
                    return true;
                }
    ...
    public static boolean A0q(E0 e02) {
        String str = e02.A02;
        if (C1020Iz.A02 > 17 || (!A0Z(573, 24, 89).equals(str) && !A0Z(426, 31, 118).equals(str))) {
            if (A0Z(147, 6, 32).equals(C1020Iz.A05)) {
                if (!A0Z(143, 4, 72).equals(C1020Iz.A06) || !e02.A05) {
                }
            }
            return false;
        }
    ...
    public static boolean A0r(String str) {
        if (C1020Iz.A02 > 23 || !A0Z(548, 25, 69).equals(str)) {
            if (C1020Iz.A02 <= 19) {
                if (A0Z(710, 6, 87).equals(C1020Iz.A03)) {
                    String[] strArr = A0e;
                    if (strArr[3].charAt(8) == strArr[0].charAt(8)) {
                        throw new RuntimeException();
                    }
    ...
    public static boolean A0s(String str) {
        return C1020Iz.A02 == 21 && A0Z(IronSourceError.ERROR_CAPPED_PER_SESSION, 22, 34).equals(str);
    }

    /* JADX WARN: Code restructure failed: missing block: B:11:0x0048, code lost:
        if (A0Z(com.bytedance.sdk.openadsdk.TTAdConstant.DEEPLINK_FALLBACK_CODE, 22, 19).equals(r4) == false) goto L14;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0t(java.lang.String r4) {
        /*
            int r0 = com.facebook.ads.redexgen.X.C1020Iz.A02
            r1 = 18
            if (r0 < r1) goto L81
            int r0 = com.facebook.ads.redexgen.X.C1020Iz.A02
            if (r0 != r1) goto L4a
        ...
        L4a:
            ...
            r0 = 19
            if (r1 != r0) goto L83
            java.lang.String r3 = com.facebook.ads.redexgen.X.C1020Iz.A06
    ...
    public static boolean A0u(String str, Format format) {
        return C1020Iz.A02 < 21 && format.A0P.isEmpty() && A0Z(313, 25, 36).equals(str);
    }

    public static boolean A0v(String str, Format format) {
        return C1020Iz.A02 <= 18 && format.A05 == 1 && A0Z(288, 25, 17).equals(str);
    }

    private boolean A0w(boolean z10) throws AM {
    ...
    public void A16(boolean z10) throws AM {
        this.A0U = new C0855Bw();
    }

    public int A1A(MediaCodec mediaCodec, E0 e02, Format format, Format format2) {
        return 0;
    }
    ...
    public E0 A1E(E6 e62, Format format, boolean z10) throws E9 {
        return e62.A6N(format.A0O, z10);
    }
        ...
        if (this.A06 != null) {
            ...
            try {
                ...
                try {
                    ...
                    this.A06 = null;
                    CL<C1372Ww> cl5 = this.A08;
                    if (cl5 != null && this.A09 != cl5) {
                        try {
                            this.A0Z.ADs(cl5);
                        } finally {
                        }
    ...
    public final void A1I() throws AM {
        ...
        if (this.A0A == null) {
            try {
                ...
                A0k(new E2(this.A07, e10, z10, -49998));
            }
            if (this.A0A == null) {
                A0k(new E2(this.A07, (Throwable) null, z10, -49999));
            }
        }
        if (!A1Q(this.A0A)) {
            return;
        ...
        try {
            ...
            A0k(new E2(this.A07, e11, z10, str2));
        }
        if (A7W() == 2) {
    ...
    public void A1L(Format format) throws AM {
        ...
        if (!C1020Iz.A0g(drmInitData2, drmInitData)) {
            if (this.A07.A0H != null) {
                CM<C1372Ww> cm = this.A0Z;
                if (A0e[5].charAt(22) != 'm') {
                    String[] strArr = A0e;
                    ...
                    if (cm != null) {
                        ...
                        if (A0e[5].charAt(22) != 'm') {
                            ...
                            CL<C1372Ww> cl2 = this.A09;
                            if (cl2 == this.A08) {
                                CM<C1372Ww> cm2 = this.A0Z;
                                String[] strArr2 = A0e;
                                if (strArr2[1].charAt(9) == strArr2[6].charAt(9)) {
                                    throw new RuntimeException();
                                }
                        ...
                        throw AM.A01(new IllegalStateException(A0Z(DownloadResource.STATUS_PAUSED_BY_APP, 34, 103)), A0y());
                    }
                }
                throw new RuntimeException();
            }
        ...
        if (this.A09 == this.A08 && (mediaCodec = this.A06) != null && (A1A = A1A(mediaCodec, this.A0A, format2, this.A07)) != 0) {
            if (A1A == 1) {
                ...
                this.A01 = 1;
                int i10 = this.A00;
                this.A0C = i10 == 2 || (i10 == 1 && this.A07.A0F == format2.A0F && this.A07.A08 == format2.A08);
            } else {
    ...
    public void A1M(X2 x22) {
    }

    public void A1O(String str, long j10, long j11) {
    }

    public boolean A1Q(E0 e02) {
        return true;
    }
    ...
    */
    ...
    @Override // com.facebook.ads.redexgen.X.E4, com.facebook.ads.redexgen.X.InterfaceC0828Au
