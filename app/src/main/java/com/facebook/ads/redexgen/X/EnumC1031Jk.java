...
public enum EnumC1031Jk {
    A0S(A01(710, 4, 82)),
    A06(A01(431, 15, 117)),
    A08(A01(457, 5, 6)),
    A0P(A01(680, 14, 112)),
    A0D(A01(DownloadResource.STATUS_CANCELED, 10, 22)),
    A0N(A01(635, 25, 113)),
    A0O(A01(660, 20, 107)),
    ...
    EnumC1031Jk(String str) {
        this.A00 = str;
    }

    public static EnumC1031Jk A00(String str) {
        EnumC1031Jk[] values;
        for (EnumC1031Jk enumC1031Jk : values()) {
            if (enumC1031Jk.A00.equalsIgnoreCase(str)) {
                return enumC1031Jk;
            }
        }
        String[] strArr = A02;
