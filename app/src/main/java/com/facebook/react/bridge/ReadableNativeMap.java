...
public class ReadableNativeMap extends NativeMap implements ReadableMap {
    ...
    public HashMap<String, Object> getLocalMap() {
        ...
        synchronized (this) {
            if (this.mKeys == null) {
                this.mKeys = (String[]) f6.a.c(importKeys());
                mJniCallCounter++;
            }
            if (this.mLocalMap == null) {
                Object[] objArr = (Object[]) f6.a.c(importValues());
                mJniCallCounter++;
                int length = this.mKeys.length;
                this.mLocalMap = new HashMap<>(length);
                for (int i10 = 0; i10 < length; i10++) {
                    this.mLocalMap.put(this.mKeys[i10], objArr[i10]);
                }
            }
        }
    ...
    private HashMap<String, ReadableType> getLocalTypeMap() {
        ...
        synchronized (this) {
            ...
            if (this.mLocalTypeMap == null) {
                Object[] objArr = (Object[]) f6.a.c(importTypes());
                mJniCallCounter++;
                int length = this.mKeys.length;
                this.mLocalTypeMap = new HashMap<>(length);
                for (int i10 = 0; i10 < length; i10++) {
                    this.mLocalTypeMap.put(this.mKeys[i10], (ReadableType) objArr[i10]);
                }
            }
        }
    ...
    private Object getValue(String str) {
        if (hasKey(str) && !isNull(str)) {
            return f6.a.c(getLocalMap().get(str));
        }
    ...
    public Iterator<Map.Entry<String, Object>> getEntryIterator() {
        ...
        final Object[] objArr = (Object[]) f6.a.c(importValues());
    ...
    public ReadableType getType(String str) {
        if (getLocalTypeMap().containsKey(str)) {
            return (ReadableType) f6.a.c(getLocalTypeMap().get(str));
        }
        throw new NoSuchKeyException(str);
    }
        ...
        for (String str : hashMap.keySet()) {
            switch (AnonymousClass3.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(str).ordinal()]) {
                ...
                case 4:
                    break;
                case 5:
                    hashMap.put(str, ((ReadableNativeMap) f6.a.c(getMap(str))).toHashMap());
                    break;
                case 6:
                    hashMap.put(str, ((ReadableArray) f6.a.c(getArray(str))).toArrayList());
                    break;
                default:
