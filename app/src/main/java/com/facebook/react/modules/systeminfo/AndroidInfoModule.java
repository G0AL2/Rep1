...
public class AndroidInfoModule extends NativePlatformConstantsAndroidSpec {
    ...
    private String uiMode() {
        ...
        return currentModeType != 1 ? currentModeType != 2 ? currentModeType != 3 ? currentModeType != 4 ? currentModeType != 6 ? DtbDeviceDataRetriever.ORIENTATION_UNKNOWN : "watch" : "tv" : "car" : "desk" : "normal";
    }
    ...
    public Map<String, Object> getTypedExportedConstants() {
        ...
        hashMap.put("isTesting", Boolean.valueOf(InneractiveMediationDefs.SHOW_HOUSE_AD_YES.equals(System.getProperty(IS_TESTING)) || isRunningScreenshotTest().booleanValue()));
        hashMap.put("reactNativeVersion", b.f37122a);
