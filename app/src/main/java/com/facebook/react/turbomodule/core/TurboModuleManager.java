...
public class TurboModuleManager implements JSIModule, TurboModuleRegistry {
    ...
    public TurboModuleManager(RuntimeExecutor runtimeExecutor, final TurboModuleManagerDelegate turboModuleManagerDelegate, CallInvokerHolder callInvokerHolder, CallInvokerHolder callInvokerHolder2) {
        ...
        this.mCxxModuleProvider = new TurboModuleProvider() { // from class: com.facebook.react.turbomodule.core.TurboModuleManager.2
            ...
            public TurboModule getModule(String str) {
                ...
                f6.a.b(legacyCxxModule instanceof TurboModule, "CxxModuleWrapper \"" + str + "\" is not a TurboModule");
    ...
    private native HybridData initHybrid(RuntimeExecutor runtimeExecutor, CallInvokerHolderImpl callInvokerHolderImpl, CallInvokerHolderImpl callInvokerHolderImpl2, TurboModuleManagerDelegate turboModuleManagerDelegate, boolean z10, boolean z11);
    ...
    private TurboModule getModule(String str, TurboModuleHolder turboModuleHolder, boolean z10) {
        boolean z11;
        TurboModule module;
        synchronized (turboModuleHolder) {
