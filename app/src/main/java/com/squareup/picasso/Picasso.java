...
public class Picasso {
    ...
    public static class Builder {
        ...
        private Downloader f28406downloader;
        ...
        public Picasso build() {
            ...
            if (this.f28406downloader == null) {
                this.f28406downloader = new OkHttp3Downloader(context);
            }
            if (this.cache == null) {
            ...
            return new Picasso(context, new Dispatcher(context, this.service, Picasso.HANDLER, this.f28406downloader, this.cache, stats), this.cache, this.listener, this.transformer, this.requestHandlers, stats, this.defaultBitmapConfig, this.indicatorsEnabled, this.loggingEnabled);
        }
        ...
        public Builder downloader(Downloader downloader2) {
            if (downloader2 != null) {
                if (this.f28406downloader == null) {
                    this.f28406downloader = downloader2;
                    return this;
                }
    ...
    Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener, RequestTransformer requestTransformer, List<RequestHandler> list, Stats stats, Bitmap.Config config, boolean z10, boolean z11) {
        ...
        arrayList.add(new NetworkRequestHandler(dispatcher.f28404downloader, stats));
