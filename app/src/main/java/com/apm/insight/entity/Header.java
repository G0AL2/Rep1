...
public final class Header {
    ...
    private static final String[] f6272a = {"version_code", "manifest_version_code", "aid", "update_version_code"};

    /* renamed from: d  reason: collision with root package name */
    private static String f6273d = null;

    /* renamed from: e  reason: collision with root package name */
    private static int f6274e = -1;
    ...
    private JSONObject f6277c = new JSONObject();
        ...
        if (f6273d == null) {
            try {
                ...
                if (TextUtils.isEmpty(sb2.toString())) {
                    f6273d = DtbDeviceDataRetriever.ORIENTATION_UNKNOWN;
                }
                f6273d = sb2.toString();
            } catch (Exception e10) {
                q.b((Throwable) e10);
    ...
    */
    ...
    public JSONObject a(Map<String, Object> map) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            if (!this.f6277c.has(entry.getKey())) {
                this.f6277c.put(entry.getKey(), entry.getValue());
            }
        }
        for (String str : f6272a) {
            if (map.containsKey(str)) {
                this.f6277c.put(str, Integer.parseInt(String.valueOf(map.get(str))));
            }
        }
        if (map.containsKey("version_code") && !map.containsKey("manifest_version_code")) {
            try {
                this.f6277c.put("manifest_version_code", Integer.parseInt(String.valueOf(map.get("version_code"))));
            } catch (Throwable unused) {
            }
        }
        if (map.containsKey("iid")) {
            this.f6277c.put("udid", map.get("iid"));
            this.f6277c.remove("iid");
        }
        if (map.containsKey("version_name")) {
            this.f6277c.put("app_version", map.get("version_name"));
            this.f6277c.remove("version_name");
        }
        return this.f6277c;
    }
    ...
    public JSONObject a(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            ...
            try {
                this.f6277c.put(next, jSONObject.opt(next));
            } catch (JSONException e10) {
                e10.printStackTrace();
            }
        }
    ...
    public JSONObject d() {
        try {
            this.f6277c.put("device_id", h.c().a());
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
        return this.f6277c;
