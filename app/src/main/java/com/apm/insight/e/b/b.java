...
public class b extends a<com.apm.insight.e.a.a> {
    ...
    public ContentValues a(com.apm.insight.e.a.a aVar) {
        ...
        contentValues.put("path", aVar.f6268a);
        contentValues.put("insert_time", Long.valueOf(aVar.f6269b));
    ...
    public void a(SQLiteDatabase sQLiteDatabase, com.apm.insight.e.a.a aVar) {
        if (aVar == null || a(sQLiteDatabase, aVar.f6268a)) {
            return;
        }
        super.a(sQLiteDatabase, (SQLiteDatabase) aVar);
        try {
            sQLiteDatabase.execSQL("delete from " + this.f6271b + " where _id in (select _id from " + this.f6271b + " order by insert_time desc limit 1000 offset 500)");
        } catch (Exception e10) {
            q.b((Throwable) e10);
        }
    }
    ...
    */
    public boolean a(android.database.sqlite.SQLiteDatabase r11, java.lang.String r12) {
        ...
        La:
            r1 = 1
            java.lang.String r3 = r10.f6271b     // Catch: java.lang.Throwable -> L26
            r4 = 0
