...
public class a {
    ...
    private Map<CrashType, List<AttachUserData>> f6117a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private Map<CrashType, List<AttachUserData>> f6118b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private Map<String, String> f6119c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    private ICrashFilter f6120d = null;

    private void c(CrashType crashType, AttachUserData attachUserData) {
        List<AttachUserData> list;
        if (this.f6117a.get(crashType) == null) {
            list = new ArrayList<>();
            this.f6117a.put(crashType, list);
        } else {
            list = this.f6117a.get(crashType);
        }
    ...
    private void d(CrashType crashType, AttachUserData attachUserData) {
        List<AttachUserData> list;
        if (this.f6118b.get(crashType) == null) {
            list = new ArrayList<>();
            this.f6118b.put(crashType, list);
        } else {
            list = this.f6118b.get(crashType);
        }
        list.add(attachUserData);
    }

    private void e(CrashType crashType, AttachUserData attachUserData) {
        List<AttachUserData> list = this.f6117a.get(crashType);
        if (list != null) {
    ...
    private void f(CrashType crashType, AttachUserData attachUserData) {
        List<AttachUserData> list = this.f6118b.get(crashType);
        if (list != null) {
            list.remove(attachUserData);
        }
    }
    ...
    public List<AttachUserData> a(CrashType crashType) {
        return this.f6117a.get(crashType);
    }
    ...
    public void a(ICrashFilter iCrashFilter) {
        this.f6120d = iCrashFilter;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void a(Map<? extends String, ? extends String> map) {
        this.f6119c.putAll(map);
    }
    ...
    public List<AttachUserData> b(CrashType crashType) {
        return this.f6118b.get(crashType);
    }
