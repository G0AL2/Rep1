...
public class d {
    ...
    private ICommonParams f6608b;

    /* renamed from: c  reason: collision with root package name */
    private ICommonParams f6609c;
    ...
    public d(Context context, ICommonParams iCommonParams, d dVar) {
        this.f6607a = context;
        this.f6608b = iCommonParams;
        this.f6609c = dVar == null ? null : dVar.f6608b;
    }
    ...
    */
    public java.util.Map<java.lang.String, java.lang.Object> b() {
        /*
            ...
            r3 = 0
            com.apm.insight.ICommonParams r4 = r9.f6609c     // Catch: java.lang.Throwable -> L25
            if (r4 == 0) goto L10
        ...
        L15:
            com.apm.insight.ICommonParams r5 = r9.f6608b     // Catch: java.lang.Throwable -> L20
        ...
        L2a:
            ...
            java.lang.String r5 = com.apm.insight.l.v.a(r5)     // Catch: java.lang.Throwable -> L3e
            r4.put(r6, r5)     // Catch: java.lang.Throwable -> L3e
            goto L3f
        L3e:
        L3f:
            boolean r5 = a(r4)
            ...
            if (r5 == 0) goto La6
            android.content.Context r5 = r9.f6607a     // Catch: java.lang.Throwable -> L81
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch: java.lang.Throwable -> L81
            android.content.Context r7 = r9.f6607a     // Catch: java.lang.Throwable -> L81
            java.lang.String r7 = r7.getPackageName()     // Catch: java.lang.Throwable -> L81
            android.content.pm.PackageInfo r5 = r5.getPackageInfo(r7, r6)     // Catch: java.lang.Throwable -> L81
            java.lang.String r6 = r5.versionName     // Catch: java.lang.Throwable -> L81
            r4.put(r0, r6)     // Catch: java.lang.Throwable -> L81
            int r6 = r5.versionCode     // Catch: java.lang.Throwable -> L81
            java.lang.Integer r6 = java.lang.Integer.valueOf(r6)     // Catch: java.lang.Throwable -> L81
            r4.put(r2, r6)     // Catch: java.lang.Throwable -> L81
            java.lang.Object r6 = r4.get(r1)     // Catch: java.lang.Throwable -> L81
            if (r6 != 0) goto Lec
            android.content.pm.ApplicationInfo r5 = r5.applicationInfo     // Catch: java.lang.Throwable -> L81
            android.os.Bundle r5 = r5.metaData     // Catch: java.lang.Throwable -> L81
            if (r5 == 0) goto L77
            java.lang.String r3 = "UPDATE_VERSION_CODE"
            java.lang.Object r3 = r5.get(r3)     // Catch: java.lang.Throwable -> L81
        L77:
            if (r3 != 0) goto L7d
            java.lang.Object r3 = r4.get(r2)     // Catch: java.lang.Throwable -> L81
        L7d:
            r4.put(r1, r3)     // Catch: java.lang.Throwable -> L81
            goto Lec
        L81:
            android.content.Context r3 = r9.f6607a
            java.lang.String r3 = com.apm.insight.l.a.d(r3)
            r4.put(r0, r3)
            android.content.Context r0 = r9.f6607a
            ...
            goto Lec
        La6:
            android.content.Context r0 = r9.f6607a     // Catch: java.lang.Throwable -> Lec
            android.content.pm.PackageManager r0 = r0.getPackageManager()     // Catch: java.lang.Throwable -> Lec
            android.content.Context r1 = r9.f6607a     // Catch: java.lang.Throwable -> Lec
            ...
            android.content.Context r2 = r9.f6607a     // Catch: java.lang.Throwable -> Lec
    ...
    public String d() {
        try {
            return this.f6608b.getDeviceId();
    ...
    public String e() {
        try {
            return String.valueOf(this.f6608b.getCommonParams().get("aid"));
        } catch (Throwable unused) {
            return "4444";
        }
    }
