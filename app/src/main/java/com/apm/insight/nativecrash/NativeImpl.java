...
public class NativeImpl {
    ...
    private static volatile boolean f6511a = false;

    /* renamed from: b  reason: collision with root package name */
    private static volatile boolean f6512b = false;

    /* renamed from: c  reason: collision with root package name */
    private static boolean f6513c = true;
    ...
    public static void a(int i10, String str) {
        if (f6511a && !TextUtils.isEmpty(str)) {
            try {
    ...
    public static boolean a(Context context) {
        ...
        if (a11) {
            ...
            doStart(Build.VERSION.SDK_INT, a10, str, h.f(), h.l());
        }
        return a11;
    }
