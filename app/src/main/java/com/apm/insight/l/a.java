...
public final class a {
    ...
    private static String f6471a = null;

    /* renamed from: b  reason: collision with root package name */
    private static Class<?> f6472b = null;

    /* renamed from: c  reason: collision with root package name */
    private static Field f6473c = null;

    /* renamed from: d  reason: collision with root package name */
    private static Field f6474d = null;

    /* renamed from: e  reason: collision with root package name */
    private static boolean f6475e = false;
    ...
    public static String d(Context context) {
        Class<?> g10 = g(context);
        if (f6473c == null && g10 != null) {
            try {
                f6473c = g10.getDeclaredField("VERSION_NAME");
    ...
    public static int e(Context context) {
        Class<?> g10 = g(context);
        if (f6474d == null && g10 != null) {
            try {
                f6474d = g10.getDeclaredField("VERSION_CODE");
            } catch (NoSuchFieldException unused) {
            }
        }
        Field field = f6474d;
    ...
    private static Class<?> g(Context context) {
        if (f6472b == null && !f6475e) {
            try {
                f6472b = Class.forName(context.getPackageName() + ".BuildConfig");
