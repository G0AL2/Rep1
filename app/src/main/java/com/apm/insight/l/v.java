...
public final class v {
    ...
    private static final StackTraceElement f6505a = new StackTraceElement("", "", "", 0);
    ...
    public static class a {
        ...
        public JSONObject a() {
            ...
            try {
                jSONObject.put("start", this.f6506a);
                jSONObject.put("end", this.f6507b);
    ...
    */
    ...
    public static JSONArray a(StackTraceElement[] stackTraceElementArr, String[] strArr) {
        ...
        if (aVar.f6506a != -1) {
            aVar.f6507b = stackTraceElementArr.length;
            jSONArray.put(aVar.a());
        }
        return jSONArray;
    }
    ...
    private static void a(Throwable th, int i10, String str, String str2) {
    ...
    private static void a(Throwable th, PrintWriter printWriter, StackTraceElement[] stackTraceElementArr, String str, String str2, Set<Throwable> set, int i10) {
        if (set.contains(th)) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            for (Throwable th2 : th.getSuppressed()) {
                int i13 = i10 / 2;
                a(th2, printWriter, stackTrace, "Suppressed: ", str2 + "\t", set, i13 > 10 ? i13 : 10);
            }
        }
        Throwable cause = th.getCause();
        if (cause != null) {
    ...
    private static void a(Throwable th, List<StackTraceElement> list, StackTraceElement[] stackTraceElementArr, String str, String str2, Set<Throwable> set, int i10) {
        if (set.contains(th)) {
            list.add(f6505a);
            return;
        }
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            for (Throwable th2 : th.getSuppressed()) {
                int i13 = i10 / 2;
                a(th2, list, stackTrace, "Suppressed: ", str2 + "\t", set, i13 > 10 ? i13 : 10);
            }
        }
        Throwable cause = th.getCause();
        if (cause != null) {
    ...
    */
    ...
    private static void b(Throwable th, int i10) {
        th.getClass();
        String localizedMessage = th.getLocalizedMessage();
        try {
            a(th.getClass().getName(), i10);
    ...
    private static void c(Throwable th, int i10) {
        if (th == null || i10 <= 0) {
            return;
        }
        b(th, i10);
