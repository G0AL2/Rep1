...
public class d implements c {
    ...
    public void a(final long j10, final Thread thread, final Throwable th, final String str, File file, final String str2, final boolean z10) {
        final File file2 = new File(o.a(this.f6331a), str);
        a.a().a(file2.getName());
        file2.mkdirs();
        i.f(file2);
        ...
        com.apm.insight.entity.a a10 = f.a().a(CrashType.JAVA, null, new c.a() { // from class: com.apm.insight.g.d.1
            ...
            public com.apm.insight.entity.a a(int i10, com.apm.insight.entity.a aVar) {
                ...
                Object b10;
                String str4;
                this.f6332a = SystemClock.uptimeMillis();
                if (i10 == 0) {
                    ...
                    if (i10 == 3) {
                        ...
                        com.apm.insight.l.a.a(d.this.f6331a, aVar.h());
                    }
                    aVar.a(str4, b10);
                } else {
                    if (c10) {
