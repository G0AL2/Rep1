...
final class d implements InputFilter {
    ...
    public static class a extends d.e {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Reference<TextView> f34849a;

        /* renamed from: b  reason: collision with root package name */
        private final Reference<d> f34850b;

        a(TextView textView, d dVar) {
            this.f34849a = new WeakReference(textView);
            this.f34850b = new WeakReference(dVar);
        }
        ...
        public void b() {
            super.b();
            TextView textView = this.f34849a.get();
            if (c(textView, this.f34850b.get()) && textView.isAttachedToWindow()) {
    ...
    private d.e a() {
        if (this.f34848b == null) {
            this.f34848b = new a(this.f34847a, this);
        }
        return this.f34848b;
    }
    ...
    public CharSequence filter(CharSequence charSequence, int i10, int i11, Spanned spanned, int i12, int i13) {
        ...
        if (d10 != 0) {
            boolean z10 = true;
            if (d10 == 1) {
                if (i13 == 0 && i12 == 0 && spanned.length() == 0 && charSequence == this.f34847a.getText()) {
                    z10 = false;
                }
