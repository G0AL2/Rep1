...
public final class b0 {
    ...
    private static final Pattern f29124a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f29125b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    */
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L32:
            ...
            if (r0 != 0) goto Lcb
            java.util.regex.Pattern r0 = da.b0.f29124a
            java.util.regex.Matcher r0 = r0.matcher(r10)
            boolean r5 = r0.matches()
            if (r5 == 0) goto Lcb
            r5 = 2
            java.lang.String r5 = r0.group(r5)     // Catch: java.lang.NumberFormatException -> Laa
            java.lang.Object r5 = ea.a.e(r5)     // Catch: java.lang.NumberFormatException -> Laa
            ...
            java.lang.Object r0 = ea.a.e(r0)     // Catch: java.lang.NumberFormatException -> Laa
        ...
        L6e:
            ...
            ea.r.h(r2, r9)     // Catch: java.lang.NumberFormatException -> Laa
        ...
        Lcb:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: da.b0.b(java.lang.String, java.lang.String):long");
    }
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f29125b.matcher(str);
        if (matcher.matches()) {
            return Long.parseLong((String) ea.a.e(matcher.group(1)));
        }
        return -1L;
    }
}
