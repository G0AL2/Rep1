...
public final class c {
    ...
    private static final ThreadLocal<TypedValue> f38915a = new ThreadLocal<>();
    ...
    private static TypedValue c() {
        ThreadLocal<TypedValue> threadLocal = f38915a;
    ...
    */
    private static android.content.res.ColorStateList e(android.content.res.Resources r17, org.xmlpull.v1.XmlPullParser r18, android.util.AttributeSet r19, android.content.res.Resources.Theme r20) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: y.c.e(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
    ...
    private static int g(int i10, float f10, float f11) {
        ...
        if (f10 != 1.0f || z10) {
            int b10 = c0.a.b((int) ((Color.alpha(i10) * f10) + 0.5f), 0, 255);
            if (z10) {
                a c10 = a.c(i10);
