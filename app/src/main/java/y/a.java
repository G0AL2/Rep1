...
public class a {
    ...
    public static a c(int i10) {
        return d(i10, j.f38946k);
    }

    static a d(int i10, j jVar) {
        float pow;
        float[] f10 = b.f(i10);
        float[][] fArr = b.f38911a;
    ...
    private static a e(float f10, float f11, float f12) {
        return f(f10, f11, f12, j.f38946k);
    }
    ...
    public static int m(float f10, float f11, float f12) {
        return n(f10, f11, f12, j.f38946k);
    }
    ...
    int o(j jVar) {
        ...
        float[][] fArr = b.f38912b;
        return z.a.a((fArr[0][0] * f18) + (fArr[0][1] * f19) + (fArr[0][2] * f20), (fArr[1][0] * f18) + (fArr[1][1] * f19) + (fArr[1][2] * f20), (f18 * fArr[2][0]) + (f19 * fArr[2][1]) + (f20 * fArr[2][2]));
    }
