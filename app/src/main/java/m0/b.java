...
class b {
    ...
    /* loaded from: classes.dex */
    public interface InterfaceC0448b<T, V> {
        V a(T t10, int i10);
    ...
    private static class c<T> implements Comparator<T> {
        ...
        private final Rect f34147a = new Rect();

        /* renamed from: b  reason: collision with root package name */
        private final Rect f34148b = new Rect();

        /* renamed from: c  reason: collision with root package name */
        private final boolean f34149c;

        /* renamed from: d  reason: collision with root package name */
        private final a<T> f34150d;
        ...
        public int compare(T t10, T t11) {
            ...
            Rect rect2 = this.f34148b;
            this.f34150d.a(t10, rect);
            this.f34150d.a(t11, rect2);
            int i10 = rect.top;
            int i11 = rect2.top;
            if (i10 < i11) {
                return -1;
    ...
    public static <L, T> T c(L l10, InterfaceC0448b<L, T> interfaceC0448b, a<T> aVar, T t10, Rect rect, int i10) {
        ...
        T t11 = null;
        int b10 = interfaceC0448b.b(l10);
        Rect rect3 = new Rect();
        for (int i11 = 0; i11 < b10; i11++) {
            T a10 = interfaceC0448b.a(l10, i11);
            if (a10 != t10) {
                aVar.a(a10, rect3);
    ...
    public static <L, T> T d(L l10, InterfaceC0448b<L, T> interfaceC0448b, a<T> aVar, T t10, int i10, boolean z10, boolean z11) {
        int b10 = interfaceC0448b.b(l10);
        ArrayList arrayList = new ArrayList(b10);
        for (int i11 = 0; i11 < b10; i11++) {
            arrayList.add(interfaceC0448b.a(l10, i11));
        }
