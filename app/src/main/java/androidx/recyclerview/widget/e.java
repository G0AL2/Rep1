...
public final class e implements Runnable {
    ...
    static final ThreadLocal<e> f3763e = new ThreadLocal<>();

    /* renamed from: f  reason: collision with root package name */
    static Comparator<c> f3764f = new a();
    ...
    ArrayList<RecyclerView> f3765a = new ArrayList<>();

    /* renamed from: d  reason: collision with root package name */
    private ArrayList<c> f3768d = new ArrayList<>();
    ...
    public static class b implements RecyclerView.p.c {
        ...
        void c(RecyclerView recyclerView, boolean z10) {
            ...
            if (z10) {
                ...
                pVar.y(this.f3769a, this.f3770b, recyclerView.mState, this);
            }
            int i10 = this.f3772d;
            if (i10 > pVar.f3578m) {
                pVar.f3578m = i10;
    ...
    private void b() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            RecyclerView recyclerView = this.f3765a.get(i11);
            if (recyclerView.getWindowVisibility() == 0) {
                recyclerView.mPrefetchRegistry.c(recyclerView, false);
                i10 += recyclerView.mPrefetchRegistry.f3772d;
            }
        }
        this.f3768d.ensureCapacity(i10);
        int i12 = 0;
        for (int i13 = 0; i13 < size; i13++) {
            RecyclerView recyclerView2 = this.f3765a.get(i13);
            if (recyclerView2.getWindowVisibility() == 0) {
                b bVar = recyclerView2.mPrefetchRegistry;
                int abs = Math.abs(bVar.f3769a) + Math.abs(bVar.f3770b);
                for (int i14 = 0; i14 < bVar.f3772d * 2; i14 += 2) {
                    if (i12 >= this.f3768d.size()) {
                        cVar = new c();
                        this.f3768d.add(cVar);
                    } else {
                        cVar = this.f3768d.get(i12);
                    }
        ...
        Collections.sort(this.f3768d, f3764f);
    }

    private void c(c cVar, long j10) {
        RecyclerView.d0 i10 = i(cVar.f3776d, cVar.f3777e, cVar.f3773a ? Long.MAX_VALUE : j10);
    ...
    private void d(long j10) {
        for (int i10 = 0; i10 < this.f3768d.size(); i10++) {
            c cVar = this.f3768d.get(i10);
            if (cVar.f3776d == null) {
                return;
            }
            c(cVar, j10);
    ...
    private RecyclerView.d0 i(RecyclerView recyclerView, int i10, long j10) {
        ...
        try {
            ...
            RecyclerView.d0 I = wVar.I(i10, false, j10);
            if (I != null) {
    ...
    public void a(RecyclerView recyclerView) {
        this.f3765a.add(recyclerView);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void f(RecyclerView recyclerView, int i10, int i11) {
        if (recyclerView.isAttachedToWindow() && this.f3766b == 0) {
            this.f3766b = recyclerView.getNanoTime();
    ...
    public void j(RecyclerView recyclerView) {
        this.f3765a.remove(recyclerView);
    }
        ...
        try {
            ...
            if (!this.f3765a.isEmpty()) {
                ...
                for (int i10 = 0; i10 < size; i10++) {
                    RecyclerView recyclerView = this.f3765a.get(i10);
                    if (recyclerView.getWindowVisibility() == 0) {
                        j10 = Math.max(recyclerView.getDrawingTime(), j10);
                    }
                }
                if (j10 != 0) {
                    g(TimeUnit.MILLISECONDS.toNanos(j10) + this.f3767c);
                }
            }
        } finally {
            this.f3766b = 0L;
