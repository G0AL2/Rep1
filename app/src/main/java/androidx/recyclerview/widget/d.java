...
public class d extends RecyclerView.o implements RecyclerView.t {
    ...
    private class c extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            if (this.f3760a) {
                this.f3760a = false;
            } else if (((Float) d.this.f3757z.getAnimatedValue()).floatValue() == 0.0f) {
                d dVar = d.this;
                dVar.A = 0;
                dVar.y(0);
            } else {
    ...
    /* loaded from: classes.dex */
    private class C0070d implements ValueAnimator.AnimatorUpdateListener {
        C0070d() {
        }
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            d.this.f3734c.setAlpha(floatValue);
            d.this.f3735d.setAlpha(floatValue);
            d.this.v();
        }
    }
    ...
    public d(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i10, int i11, int i12) {
        ...
        ofFloat.addUpdateListener(new C0070d());
        j(recyclerView);
    }
    ...
    private void m(Canvas canvas) {
        ...
        int i14 = this.f3745n;
        int i15 = i13 - (i14 / 2);
        this.f3738g.setBounds(0, 0, i14, i11);
    ...
    public void a(RecyclerView recyclerView, MotionEvent motionEvent) {
        ...
        } else if (motionEvent.getAction() == 1 && this.f3753v == 2) {
            this.f3744m = 0.0f;
            this.f3747p = 0.0f;
            y(1);
            this.f3754w = 0;
        } else if (motionEvent.getAction() == 2 && this.f3753v == 2) {
            A();
            if (this.f3754w == 1) {
                r(motionEvent.getX());
            }
