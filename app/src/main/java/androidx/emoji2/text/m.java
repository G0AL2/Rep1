...
public final class m extends SpannableStringBuilder {
    ...
    public static class a implements TextWatcher, SpanWatcher {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final AtomicInteger f2957b = new AtomicInteger(0);
        ...
        final void a() {
            this.f2957b.incrementAndGet();
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
            ((TextWatcher) this.f2956a).afterTextChanged(editable);
        }

        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f2956a).beforeTextChanged(charSequence, i10, i11, i12);
        }

        final void c() {
            this.f2957b.decrementAndGet();
        }

        @Override // android.text.SpanWatcher
        public void onSpanAdded(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f2957b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f2956a).onSpanAdded(spannable, obj, i10, i11);
            }
        }
        ...
        public void onSpanChanged(Spannable spannable, Object obj, int i10, int i11, int i12, int i13) {
            if (this.f2957b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f2956a).onSpanChanged(spannable, obj, i10, i11, i12, i13);
            }
        }
        ...
        public void onSpanRemoved(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f2957b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f2956a).onSpanRemoved(spannable, obj, i10, i11);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f2956a).onTextChanged(charSequence, i10, i11, i12);
        }
    }
    ...
    m(Class<?> cls, CharSequence charSequence) {
        ...
        h0.g.g(cls, "watcherClass cannot be null");
        this.f2954a = cls;
    }

    private void b() {
        for (int i10 = 0; i10 < this.f2955b.size(); i10++) {
            this.f2955b.get(i10).a();
        }
    }
    ...
    private void e() {
        for (int i10 = 0; i10 < this.f2955b.size(); i10++) {
            this.f2955b.get(i10).onTextChanged(this, 0, length(), length());
        }
    }

    private a f(Object obj) {
        for (int i10 = 0; i10 < this.f2955b.size(); i10++) {
            a aVar = this.f2955b.get(i10);
            if (aVar.f2956a == obj) {
                return aVar;
            }
        }
    ...
    public CharSequence subSequence(int i10, int i11) {
        return new m(this.f2954a, this, i10, i11);
    }
