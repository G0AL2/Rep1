...
public class d {
    ...
    public static class a implements TypeEvaluator<PathParser.PathDataNode[]> {
        ...
        public d.b[] evaluate(float f10, d.b[] bVarArr, d.b[] bVarArr2) {
            if (z.d.b(bVarArr, bVarArr2)) {
                if (!z.d.b(this.f4182a, bVarArr)) {
                    this.f4182a = z.d.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f4182a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f4182a;
            }
    ...
    */
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i10, int i11, int i12, String str) {
        ...
        if (i10 == 2) {
            ...
            d.b[] d10 = z.d.d(string);
            d.b[] d11 = z.d.d(string2);
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k10 = i.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f4168j);
        int i10 = 0;
        TypedValue l10 = i.l(k10, xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0);
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray k10 = i.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f4165g);
        TypedArray k11 = i.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f4169k);
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (z10) {
            if (i10 != 0) {
                ofInt = (i10 == 1 || i10 == 3) ? Keyframe.ofInt(f10, i.g(k10, xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0, 0)) : null;
            } else {
                ofInt = Keyframe.ofFloat(f10, i.f(k10, xmlPullParser, AppMeasurementSdk.ConditionalUserProperty.VALUE, 0, 0.0f));
            }
        } else if (i10 == 0) {
        ...
        while (true) {
            ...
            if (eventType == 3 || eventType == 1) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    TypedArray k10 = i.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f4167i);
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f10, XmlPullParser xmlPullParser) {
        long g10 = i.g(typedArray, xmlPullParser, "duration", 1, ms.bd.o.Pgl.c.COLLECT_MODE_FINANCE);
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f10, XmlPullParser xmlPullParser) {
        ...
        if (i11 != null) {
            ...
            s(z.d.e(i11), objectAnimator, f10 * 0.5f, i12, i13);
            return;
        }
