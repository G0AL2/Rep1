...
class i {
    ...
    private final CheckedTextView f1537a;

    /* renamed from: b  reason: collision with root package name */
    private ColorStateList f1538b = null;

    /* renamed from: c  reason: collision with root package name */
    private PorterDuff.Mode f1539c = null;
    ...
    public i(CheckedTextView checkedTextView) {
        this.f1537a = checkedTextView;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void a() {
        Drawable a10 = androidx.core.widget.c.a(this.f1537a);
        if (a10 != null) {
            if (this.f1540d || this.f1541e) {
                Drawable mutate = androidx.core.graphics.drawable.a.r(a10).mutate();
                if (this.f1540d) {
                    androidx.core.graphics.drawable.a.o(mutate, this.f1538b);
                }
                if (this.f1541e) {
                    androidx.core.graphics.drawable.a.p(mutate, this.f1539c);
                }
                if (mutate.isStateful()) {
                    mutate.setState(this.f1537a.getDrawableState());
                }
                this.f1537a.setCheckMarkDrawable(mutate);
            }
        }
    }
    ...
    */
    public void d(android.util.AttributeSet r10, int r11) {
        /*
            ...
            int r10 = d.j.O0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L3a
            int r10 = r0.n(r10, r8)     // Catch: java.lang.Throwable -> L84
            if (r10 == 0) goto L3a
            android.widget.CheckedTextView r11 = r9.f1537a     // Catch: android.content.res.Resources.NotFoundException -> L3a java.lang.Throwable -> L84
        ...
        L3b:
            if (r10 != 0) goto L58
            int r10 = d.j.N0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L58
            int r10 = r0.n(r10, r8)     // Catch: java.lang.Throwable -> L84
            if (r10 == 0) goto L58
            android.widget.CheckedTextView r11 = r9.f1537a     // Catch: java.lang.Throwable -> L84
        ...
        L58:
            int r10 = d.j.P0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L69
            android.widget.CheckedTextView r11 = r9.f1537a     // Catch: java.lang.Throwable -> L84
        ...
        L69:
            int r10 = d.j.Q0     // Catch: java.lang.Throwable -> L84
            boolean r11 = r0.s(r10)     // Catch: java.lang.Throwable -> L84
            if (r11 == 0) goto L80
            android.widget.CheckedTextView r11 = r9.f1537a     // Catch: java.lang.Throwable -> L84
            r1 = -1
