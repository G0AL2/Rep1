...
public class u {
    ...
    private static final int[] f1731c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    private final ProgressBar f1732a;

    /* renamed from: b  reason: collision with root package name */
    private Bitmap f1733b;
    ...
    public void c(AttributeSet attributeSet, int i10) {
        z0 v10 = z0.v(this.f1732a.getContext(), attributeSet, f1731c, i10, 0);
        Drawable h10 = v10.h(0);
        if (h10 != null) {
            this.f1732a.setIndeterminateDrawable(e(h10));
        }
        Drawable h11 = v10.h(1);
        if (h11 != null) {
            this.f1732a.setProgressDrawable(d(h11, false));
        }
        v10.w();
    }

    Drawable d(Drawable drawable, boolean z10) {
        if (drawable instanceof a0.b) {
            a0.b bVar = (a0.b) drawable;
            Drawable a10 = bVar.a();
            if (a10 != null) {
                bVar.b(d(a10, z10));
            }
