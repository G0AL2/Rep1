...
public class q0 extends o0 {
        ...
        public SsResponse intercept(Interceptor.Chain chain) throws Exception {
            ...
            while (true) {
                ...
                if (((String) pblk.a(16777217, 0, 0L, "b86b16", new byte[]{107, 119, 81, 91, 20, 41, 102})).equals(header.getName()) && header.getValue() != null) {
                    ...
                    pblb.a(117440513, 0, q0.this.f34570b, (String) pblk.a(16777217, 0, 0L, "e1acaa", new byte[]{102, 54, 2, 24, 76, 98}), (String[]) arrayList.toArray(new String[0]));
                    break;
                }
            }
            return proceed;
    ...
    protected Object a(long j10) {
        ...
        this.f34569a = pglaVar;
        RetrofitUtils.addInterceptor(pglaVar);
        return Boolean.TRUE;
    }

    protected void finalize() throws Throwable {
        RetrofitUtils.removeInterceptor(this.f34569a);
        super.finalize();
    }
}
