...
public class d {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f39858a != bVarArr2[i10].f39858a || bVarArr[i10].f39859b.length != bVarArr2[i10].f39859b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    private static void g(java.lang.String r8, int r9, z.d.a r10) {
        /*
            r0 = 0
            r10.f39857b = r0
            r1 = r9
        ...
        L3d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: z.d.g(java.lang.String, int, z.d$a):void");
    }
    ...
    public static void j(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f39858a = bVarArr2[i10].f39858a;
            for (int i11 = 0; i11 < bVarArr2[i10].f39859b.length; i11++) {
                bVarArr[i10].f39859b[i11] = bVarArr2[i10].f39859b[i11];
            }
        }
    }
    ...
    public static class b {
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            char c10 = 'm';
            for (int i10 = 0; i10 < bVarArr.length; i10++) {
                a(path, fArr, c10, bVarArr[i10].f39858a, bVarArr[i10].f39859b);
                c10 = bVarArr[i10].f39858a;
            }
        }

        public void d(b bVar, b bVar2, float f10) {
            this.f39858a = bVar.f39858a;
            int i10 = 0;
            while (true) {
                float[] fArr = bVar.f39859b;
                if (i10 >= fArr.length) {
                    return;
                }
                this.f39859b[i10] = (fArr[i10] * (1.0f - f10)) + (bVar2.f39859b[i10] * f10);
                i10++;
            }
        }
        ...
        b(b bVar) {
            this.f39858a = bVar.f39858a;
            float[] fArr = bVar.f39859b;
            this.f39859b = d.c(fArr, 0, fArr.length);
        }
    }
}
