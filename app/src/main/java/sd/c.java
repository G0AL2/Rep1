...
public class c implements pd.b {
    ...
    private class a implements Runnable {
        ...
        public void run() {
            ...
            String str = null;
            for (Map.Entry<String, b> entry : c.f36981a.a().entrySet()) {
            ...
            if (hashMap.size() > 0) {
                this.f36982a.onSignalsCollected(new JSONObject(hashMap).toString());
            } else if (str == null) {
                this.f36982a.onSignalsCollected("");
            } else {
                this.f36982a.onSignalsCollectionFailed(str);
            }
        }
    }
