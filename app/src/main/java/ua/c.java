...
public class c {
    public static ColorStateList a(Context context, TypedArray typedArray, int i10) {
        ...
        int resourceId;
        ColorStateList a10;
        if (!typedArray.hasValue(i10) || (resourceId = typedArray.getResourceId(i10, 0)) == 0 || (a10 = e.a.a(context, resourceId)) == null) {
    ...
    public static ColorStateList b(Context context, z0 z0Var, int i10) {
        ...
        int n10;
        ColorStateList a10;
        if (!z0Var.s(i10) || (n10 = z0Var.n(i10, 0)) == 0 || (a10 = e.a.a(context, n10)) == null) {
