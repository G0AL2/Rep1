...
public final class a {
    ...
    private static final String[] f33119a = new String[0];
    ...
    public static String[] a(EditorInfo editorInfo) {
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            return strArr != null ? strArr : f33119a;
        }
        ...
        return stringArray != null ? stringArray : f33119a;
    }
    ...
    public static void e(EditorInfo editorInfo, CharSequence charSequence, int i10) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            C0423a.a(editorInfo, charSequence, i10);
            return;
        }
    ...
    public static void f(EditorInfo editorInfo, CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 30) {
            C0423a.a(editorInfo, charSequence, 0);
        } else {
