...
public final class h {
    ...
    private static final Object f31052a = new Object();

    /* renamed from: b  reason: collision with root package name */
    private static char[] f31053b = new char[24];
    ...
    public static void d(long j10, PrintWriter printWriter, int i10) {
        synchronized (f31052a) {
            printWriter.print(new String(f31053b, 0, e(j10, i10)));
        }
    }
    ...
    private static int e(long j10, int i10) {
        ...
        int i15;
        long j11 = j10;
        if (f31053b.length < i10) {
            f31053b = new char[i10];
        }
        char[] cArr = f31053b;
        ...
        if (floor > 86400) {
            i11 = floor / Constants.MAX_RETRY_AFTER;
            floor -= Constants.MAX_RETRY_AFTER * i11;
        } else {
            i11 = 0;
        }
        if (floor > 3600) {
